...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Ticket Information' => 'Informacije o zahtevku',
        ...
        'To protect your privacy, active or/and remote content has blocked.' =>
            'Da bi zaščitili vašo zasebnost, so blokirane aktivne ali/in daljinske vsebine.',
        ...
        #
        '%s Tickets affected! Do you really want to use this job?' => '%s zahtevkov pokvarjenih! Ali res želite uporabiti ta "job"??',
        '(Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behinde a dial-up line $!)' =>
            '(Preverite "MX" zapise uporabljenih naslovov E-pošte, ki sestavljajo odgovor. Ne uporabljejte te funkcije če je vaš OTRS server na "dial-up" liniji!)',
        '(Email of the system admin)' => '(E-pošta sistemskega administratorja)',
        '(Full qualified domain name of your system)' => '(Polno ime domene vašega sistema)',
        '(Note: To je odvisno od vaše namestitve, koliko dinamičnih objektov lahko uporabljate)' =>
            '(Opomba: To je odvisno od vaše namestitve, koliko dinamičnih objektov lahko uporabljate)',
        ...
        'A message should have a body!' => 'Sporočilo mora imeti besedilo!',
        ...
        'About OTRS' => 'O OTRS-u',
        'Absolut Period' => 'Absolutno obdobje',
        'Activates TypeAhead for the autocomplete feature, that enables users to type in whatever speed they desire, without losing any information. Often this means that keystrokes entered will not be displayed on the screen immediately.' =>
            'Aktivira "tipkanje unaprijed" za funkciju autokompletiranja, koja omogućava korisnicima da ukucavaju teks bilo kojom brzinom, bez gubljenja informacija. Najčešće to znači da na ekranu neće svaki pritisak na tipku biti odmah prikazan.',
        'Add Customer User' => 'Dodaj uporabnika',
        'Add System Address' => 'Dodaj sistemski naslov',
        'Add User' => 'Dodaj uporabnika',
        'Add a new Agent.' => 'Dodaj novega zaposlenega.',
        'Add a new Customer Company.' => 'Dodaj novu podjetje.',
        'Add a new Group.' => 'Dodaj novo skupino.',
        'Add a new Notification.' => 'Dodaj novo obvestilo.',
        'Add a new Priority.' => 'Dodaj novo prioriteto.',
        'Add a new Role.' => 'Dodaj novo vlogu.',
        'Add a new SLA.' => 'Dodaj novo SLA.',
        'Add a new Salutation.' => 'Dodaj nov pozdrav.',
        'Add a new Service.' => 'Dodaj nov servis.',
        'Add a new Signature.' => 'Dodaj nov podpis.',
        'Add a new State.' => 'Dodaj nov status.',
        ...
        'Adds the one time vacation days for the calendar number 2. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Jednokratno dodaje neradne dane za kalendar broj 2. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the one time vacation days for the calendar number 3. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Jednokratno dodaje neradne dane za kalendar broj 3. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the one time vacation days for the calendar number 4. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Jednokratno dodaje neradne dane za kalendar broj 4. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the one time vacation days for the calendar number 5. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Jednokratno dodaje neradne dane za kalendar broj 5. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the one time vacation days for the calendar number 6. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Jednokratno dodaje neradne dane za kalendar broj 6. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the one time vacation days for the calendar number 7. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Jednokratno dodaje neradne dane za kalendar broj 7. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the one time vacation days for the calendar number 8. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Jednokratno dodaje neradne dane za kalendar broj 8. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the one time vacation days for the calendar number 9. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Jednokratno dodaje neradne dane za kalendar broj 9. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the permanent vacation days for the calendar number 1. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Trajno dodaje neradne dane za kalendar broj 1. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the permanent vacation days for the calendar number 2. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Trajno dodaje neradne dane za kalendar broj 2. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the permanent vacation days for the calendar number 3. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Trajno dodaje neradne dane za kalendar broj 3. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the permanent vacation days for the calendar number 4. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Trajno dodaje neradne dane za kalendar broj 4. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the permanent vacation days for the calendar number 5. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Trajno dodaje neradne dane za kalendar broj 5. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the permanent vacation days for the calendar number 6. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Trajno dodaje neradne dane za kalendar broj 6. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the permanent vacation days for the calendar number 7. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Trajno dodaje neradne dane za kalendar broj 7. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the permanent vacation days for the calendar number 8. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Trajno dodaje neradne dane za kalendar broj 8. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Adds the permanent vacation days for the calendar number 9. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'Trajno dodaje neradne dane za kalendar broj 9. Molimo Vas da koristite jednoznamenkasti broj od 1 do 9 (umjesto 01 - 09).',
        'Admin-Area' => 'Admin prostor',
        'Admin-Password' => 'Geslo administratorja',
        'Admin-User' => 'Administrator',
        'Admin-password' => 'Geslo administratorja',
        'Agent Mailbox' => 'poštni predal zaposlenih',
        'Agent Preferences' => 'Nastavitve zaposlenega',
        'Agent based' => 'Na osnovi zaposlenega',
        'Agent-Area' => 'Prostor zaposlenih',
        'All Agent variables.' => 'Vse spremenljivke zaposlenih',
        'All Agents' => 'Vsi zaposleni',
        'All Customer variables like defined in config option CustomerUser.' =>
            'Vse uporabniške spremenljivke kot so definirane nastavitvenih možnostih za uporabnika.',
        'All customer tickets.' => 'Vsi zahtevki za uporabnika.',
        'All email addresses get excluded on replaying on composing an email.' =>
            'Vsi naslovi e-pošte bodo izključeni pri kreiranju odgovora.',
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' =>
            'Sve poruke E-pošte s ovim primateljem (Za:) bit će otpremljene u izabrani rep!',
        'All messages' => 'Vsa sporočila',
        'All new tickets!' => 'Vsi novi zahtevki!',
        'All tickets where the reminder date has reached!' => 'Vsi zahtevki, kjer je dosežen opomnik za datum!',
        'All tickets which are escalated!' => 'Vsi eskalirani zahtevki!',
        'Allocate CustomerUser to service' => 'Dodelitev uporabnika na servis',
        'Allocate services to CustomerUser' => 'Dodeli storitve uporabniku',
        'Allows defining services and SLAs for tickets (e. g. email, desktop, network, ...), and escalation attribrutes for SLAs (if ticket service/SLA feature is enabled).' =>
            'Dozvoljava definiranje servisa i SLA za kartice (npr E-pošta, radna površina, mreža, ...), i eskalacijske atribute za SLA (ako je aktivirana usluga/SLA za karticu).',
        'Answer' => 'Odgovor',
        'Article Create Times' => 'Čas ustvarjanja članka',
        'Article created' => 'Članek ustvarjen',
        'Article created between' => 'Članek ustvarjen med',
        'Article filter settings' => 'Postavke filtra za članke',
        'Article free text options shown in the close ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'Opcije slobodnog teksta članka prikazane na zatvorenom ekranu kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the email ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'Opcije slobodnog teksta članka prikazane na e-mail ekranu kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the phone ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'Opcije slobodnog teksta članka prikazane na ekranu telefonske kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket compose screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'Opcije slobodnog teksta članka prikazane na ekranu za pisanje kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket free text screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'Opcije slobodnog teksta članka prikazane na ekranu slobodnog teksta kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket note screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'Opcije slobodnog teksta članka prikazane na ekranu napomene kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket owner screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'Opcije slobodnog teksta članka prikazane na ekranu vlasnika kartice na sučelju zaposlenog pri uvećanom prikazu. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket pending screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'Opcije slobodnog teksta članka prikazane na ekranu čekanja kartice na sučelju zaposlenog pri uvećanom prikazu. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket phone outbound screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'Opcije slobodnog teksta članka prikazane na ekranu odlazne telefonske kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket priority screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'Opcije slobodnog teksta članka prikazane na ekranu prioriteta kartice na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Article free text options shown in the ticket responsible screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'Opcije slobodnog teksta članka prikazane na ekranu odgovornog za karticu na sučelju zaposlenog. Moguće postavke: 0 = isključeno, 1 = uključeno, 2 = uključeno i obavezno.',
        'Attach' => 'Dodaj priponko',
        'Attribute' => 'Atribut',
        'Auto Response From' => 'Avtomatski odgovor od',
        'Bounce Ticket: ' => 'Preusmeri zahtevek',
        'Bounce ticket' => 'Preusmeri zahtevek',
        'CSV' => 'CSV',
        'Can not create link with %s!' => 'Ni mogoče ustvariti povezave z %s!',
        'Can not delete link with %s!' => 'Ne morem izbrisati povezavo z %s!',
        'Can\'t update password, must be at least %s characters!' => 'Ne morem posodobiti gesla, vsebovati mora vsaj %s znakov!',
        'Can\'t update password, must contain 2 lower and 2 upper characters!' =>
            'Ne morem posodobiti gesla, vsebovati mora vsaj 2 manjša in 2 velika znaka!',
        'Can\'t update password, needs at least 1 digit!' => 'Ne morem posodobiti gesla, potrebna je vsaj 1 števka!!',
        'Can\'t update password, needs at least 2 characters!' => 'Ne morem posodobiti gesla, potrebujet vsaj 2 znaka!',
        'Can\'t update password, your new passwords do not match! Please try again!' =>
        ...
        'Change Times' => 'Spremeni čas',
        'Change free text of ticket' => 'Spremeni prosto besedilo za zahtevek',
        'Change owner of ticket' => 'Spremeni lastnika zahtevka',
        'Change priority of ticket' => 'Spremeni prioriteto zahtevka',
        ...
        'Check Mail Configuration' => 'Preveri nastavitve E-pošte',
        'Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behind a dial-up line!' =>
            'Preverite "MX" zapise uporabljenih naslovov E-pošte z kreiranjem odgovora. Ne uporabljajte te funkcije če je vaš OTRS server na "dial-up" liniji.',
        'Child-Object' => 'Otroški objekti',
        'City{CustomerUser}' => 'Mesto (uporabnik)',
        'Classification' => 'Klasifikacija',
        'Clear From' => 'Od: izbriši',
        'Clear To' => 'Izbriši Za:',
        ...
        'CompanyTickets' => 'zahtevki podjetja',
        'Compose Answer' => 'Sestavi odgovor',
        'Compose Email' => 'Sestavi E-pošto',
        'Compose Follow up' => 'Sestavi nadaljevanje',
        'Config Options' => 'Nastavitvene možnosti',
        'Config options (e. g. <OTRS_CONFIG_HttpType>)' => 'Nastavitvene možnosti (npr. <OTRS_CONFIG_HttpType>)',
        'Config options (e. g. <OTRS_CONFIG_HttpType>).' => 'Nastavitvene možnosti opcije (npr. <OTRS_CONFIG_HttpType).',
        'Contact customer' => 'Kontaktirajte uporabnika',
        ...
        'Create your first Ticket' => 'Ustvarite svoj prvi zahtevek',
        'Create/Expires' => 'Ustvarjen/Poteče',
        'CreateTicket' => 'Odpiranje zahtevka',
        'Current Impact Rating' => 'Trenutna ocena učinka',
        'Customer Move Notify' => 'Obvestilo o premiku uporabnika',
        'Customer User' => 'Zahtevano od',
        'Customer User Management' => 'Upravljanje z uporabniki',
        'Customer Users' => 'Stranke',
        'Customer Users <-> Groups' => 'Stranke <-> skupine',
        'Customer Users <-> Groups Management' => 'Uporabniki <-> Upravljanje s skupinami',
        'Customer Users <-> Services' => 'Uporabniki <-> Servisi',
        'Customer Users <-> Services Management' => 'Uporabniki <-> Upravljanje s servisi',
        'Customer history' => 'Zgodovina uporabnika',
        'Customer history search' => 'Zgodovina iskanja za uporabnika',
        'Customer history search (e. g. "ID342425").' => 'Zgodovina iskanja za uporabnika (npr. "ID342425").',
        'Customer item (icon) which shows the open tickets of this customer as info block.' =>
            'Uporabniški element (ikona), ki prikazuje odprte zahtevke te stranke kot info blok.',
        'CustomerID{CustomerUser}' => 'ID uporabnika.',
        'CustomerUser' => 'Uporabnik',
        'D' => 'D',
        'DB Admin Password' => 'Geslo DB administratorja',
        'DB Admin User' => 'DB administrator',
        'DB connect host' => 'Ime ali naslov DB serverja',
        'Default' => 'privzeto',
        ...
        'Defines the default selection of the free key field number 1 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 1 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 10 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 10 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 11 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 11 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 12 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 12 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 13 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 13 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 14 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 14 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 15 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 15 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 16 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 16 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 2 for articles (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 2 za članek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 2 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 2 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 3 for articles (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 3 za članek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 3 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 3 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 4 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 4 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 5 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 5 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 6 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 6 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 7 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 7 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 8 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 8 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free key field number 9 for tickets (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 9 za zahtevek (če je na voljo več kot eno možnost).',
        'Defines the default selection of the free text field number 1 for articles (if more than one option is provided).' =>
            'Določa privzeto izbiro prostega tekstovnega polja številka 1 za članke (če je na voljo več kot eno možnost).',
        ...
        'Defines the free key field number 1 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 1 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        ...
        'Defines the free text field number 10 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 10 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free text field number 11 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 11 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free text field number 12 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 12 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free text field number 13 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 13 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free text field number 14 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 14 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free text field number 15 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 15 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free text field number 16 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 16 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free text field number 2 for articles to add a new article attribute.' =>
            'Določa prosto tekstovno polje številka 2 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        ...
        'Defines the free text field number 3 for articles to add a new article attribute.' =>
            'Določa prosto tekstovno polje številka 3 za zahtevke zaradi dodajanja nove lastnosti zahtevku..',
        ...
        'Defines the free text field number 4 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 4 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free text field number 5 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 5 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free text field number 6 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 6 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free text field number 7 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 7 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free text field number 8 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 8 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free text field number 9 for tickets to add a new ticket attribute.' =>
            'Določa prosto tekstovno polje številka 9 za zahtevke zaradi dodajanja nove lastnosti zahtevku.',
        'Defines the free time key field number 1 for tickets.' => 'Določa prosto polje ključa časa številka 1 za zahtevke.',
        'Defines the free time key field number 2 for tickets.' => 'Določa prosto polje ključa časa številka 2 za zahtevke.',
        'Defines the free time key field number 3 for tickets.' => 'Določa prosto polje ključa časa številka 3 za zahtevke.',
        'Defines the free time key field number 4 for tickets.' => 'Določa prosto polje ključa časa številka 4 za zahtevke.',
        'Defines the free time key field number 5 for tickets.' => 'Določa prosto polje ključa časa številka 5 za zahtevke.',
        'Defines the free time key field number 6 for tickets.' => 'Določa prosto polje ključa časa številka 6 za zahtevke.',
        'Defines the hours and week days of the calendar number 1, to count the working time.' =>
            'Določa ure in dneve v tednu za kolendar številka 1, za štetje delovnega časa.',
        'Defines the hours and week days of the calendar number 2, to count the working time.' =>
            'Določa ure in dneve v tednu za kolendar številka 2, za štetje delovnega časa.',
        'Defines the hours and week days of the calendar number 3, to count the working time.' =>
            'Določa ure in dneve v tednu za kolendar številka 3, za štetje delovnega časa.',
        'Defines the hours and week days of the calendar number 4, to count the working time.' =>
            'Določa ure in dneve v tednu za kolendar številka 4, za štetje delovnega časa.',
        'Defines the hours and week days of the calendar number 5, to count the working time.' =>
            'Določa ure in dneve v tednu za kolendar številka 5, za štetje delovnega časa.',
        'Defines the hours and week days of the calendar number 6, to count the working time.' =>
            'Določa ure in dneve v tednu za kolendar številka 6, za štetje delovnega časa.',
        'Defines the hours and week days of the calendar number 7, to count the working time.' =>
            'Določa ure in dneve v tednu za kolendar številka 7, za štetje delovnega časa.',
        'Defines the hours and week days of the calendar number 8, to count the working time.' =>
            'Določa ure in dneve v tednu za kolendar številka 8, za štetje delovnega časa.',
        'Defines the hours and week days of the calendar number 9, to count the working time.' =>
            'Določa ure in dneve v tednu za kolendar številka 9, za štetje delovnega časa.',
        'Defines the http link for the free text field number 1 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 1 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 10 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 10 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 11 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 11 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 12 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 12 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 13 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 13 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 14 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 14 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 15 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 15 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 16 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 16 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 2 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 2 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 3 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 3 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 4 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 4 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 5 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 5 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 6 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 6 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 7 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 7 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 8 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 8 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the http link for the free text field number 9 for tickets (it will be used in every ticket view).' =>
            'Določa http povezavo za brezplačno polje besedila številka 9 iz zahtevka (bo uporabljeno v vsakem pregledu zahtevka).',
        'Defines the name of the calendar number 1.' => 'Določa ime koledarja številka 1.',
        'Defines the name of the calendar number 2.' => 'Določa ime koledarja številka 2.',
        'Defines the name of the calendar number 3.' => 'Določa ime koledarja številka 3.',
        'Defines the name of the calendar number 4.' => 'Določa ime koledarja številka 4.',
        'Defines the name of the calendar number 5.' => 'Določa ime koledarja številka 5.',
        'Defines the name of the calendar number 6.' => 'Določa ime koledarja številka 6.',
        'Defines the name of the calendar number 7.' => 'Določa ime koledarja številka 7.',
        'Defines the name of the calendar number 8.' => 'Določa ime koledarja številka 8.',
        'Defines the name of the calendar number 9.' => 'Določa ime koledarja številka 9.',
        'Defines whether the free time field number 1 is optional or not.' =>
            'Določa če je prosto polje časa številka 1 neobvezno ali ne.',
        'Defines whether the free time field number 2 is optional or not.' =>
            'Določa če je prosto polje časa številka 2 neobvezno ali ne.',
        'Defines whether the free time field number 3 is optional or not.' =>
            'Določa če je prosto polje časa številka 3 neobvezno ali ne.',
        'Defines whether the free time field number 4 is optional or not.' =>
            'Določa če je prosto polje časa številka 4 neobvezno ali ne.',
        'Defines whether the free time field number 5 is optional or not.' =>
            'Določa če je prosto polje časa številka 5 neobvezno ali ne.',
        ...
        'Do dispatch or filter incoming emails based on email X-Headers! RegExp is also possible.' =>
            'Otpemi il filtriraj dolazne porukena osnovu "X-Headers"! "RegExp" je takođe moguć.',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' =>
            'Molimo da ne koristite "UserID 1" (račun sustava) za rad! Kreirajte korisničke račune!',
        'Download Settings' => 'Prenesi nastavitve',
        'Drop Database' => 'Izbriši bazo podatkov',
        'Dynamic-Object' => 'Dinamični objekt',
        'Edit Customers' => 'Uredi uporabnike',
        'Edit default services.' => 'Uredi privzete servise.',
        'Email based' => 'Na osnovi E-pošte',
        'Email of the system admin.' => 'Naslov E-pošte administratorja sistema.',
        'Email{CustomerUser}' => 'Uporabnik (E-pošta)',
        'Escalation - First Response Time' => 'Eskalacija - Čas reakcije',
        'Escalation - Solution Time' => 'Eskalacija - Čas rešitve',
        'Escalation - Update Time' => 'Eskalacija - Čas posodobitve',
        'Escalation Times' => 'Čas eskalacije',
        'Escalation time' => 'Čas eskalacije',
        'Event is required!' => 'Dogodek je obvezen!',
        'Explanation' => 'Razlaga',
        'Export Config' => 'Izvozi nastavitve',
        'FAQ Search Result' => 'Rezultati iskanja FAQ',
        'FAQ System History' => 'Dnevnik FAQ sistema',
        'Fax{CustomerUser}' => 'Uporabnik (Faks)',
        'File-Name' => 'Naziv datoteke',
        'File-Path' => 'Poti datoteke',
        'Filelist' => 'Lista datotek',
        ...
        'Foward ticket: ' => 'Posreduj zahtevek',
        'Frontend' => 'Vmesnik',
        'Full qualified domain name of your system.' => 'Polno ime domene vašega sistema."',
        'Go' => 'Pojdi',
        'Go to group %s' => 'Pojdi na skupino %s',
        'Group %s' => 'Skupina %s',
        'Group Ro' => 'Skupina "ro"',
        'Group based' => 'Na osnovi skupine',
        'Group selection' => 'Izbor skupine',
        'Hash/Fingerprint' => '"Hash"/Povzetek',
        'Have a lot of fun!' => 'Imejte veliko zabave!',
        'Have you lost your password?' => 'Ste izgubili geslo?',
        'Help' => 'Pomoč',
        'Here you can define the x-axis. You can select one element via the radio button. If you make no selection all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' =>
            'Tukaj lahko določite x-os. Izberete lahko en element od ponujenih možnosti. Če nič ne izberete se bodo uporabili vsi elementi pri pripravljanju statistike. Prav tako je dodan nov atribut  od zadnje konfiguracije.',
        'Here you can insert a description of the stat.' => 'Tukaj lahko vstavite opis statistike.',
        'Here you can select the dynamic object you want to use.' => 'Tukaj lahko izberete dinamičen predmet, ki ga želite uporabiti.',
        'Home' => 'Začetna',
        'If a new hardcoded file is available this attribute will be shown and you can select one.' =>
            'Če je nova hardcoded datoteka dostopna, potem bo ta atribut prikazan in lahko si izberete enega.',
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.' =>
            'Če je zahtevek prevzet, uporabnik pa pošlje nadaljevanje zahtevka, bo zahtevek prenešen na starega lastnika.',
        'If a ticket will not be answered in this time, just only this ticket will be shown.' =>
            'Če ne bo odgovorjeno na zahtevek v določenem času, potem bo prikazan samo ta zahtevek.',
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.' =>
            'Če zaposleni prevzame zahtevek in ne odgovori na zahtevek v določenem času bo zahtevek avtomatsko odklenjen. Ta zahtevek bo potem viden vsem uporabnikom.',
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).' =>
            'Če ni nič izbrano, potem ni nobenih dovoljen v tej skupini (zahtevki ne bodo na voljo uporabniku).',
        'If you need the sum of every column select yes.' => 'Če želite vsoto vsakega stolpca izberite "Da".',
        'If you need the sum of every row select yes' => 'Če želite vsoto v vsaki vrstici izberite "Da".',
        'Image' => 'Slika',
        'Important' => 'Pomembno',
        'Imported' => 'Uvoženo',
        'Imported by' => 'Uvoženi z',
        'In order to experience OTRS, you\'ll need to enable Javascript in your browser.' =>
            'Za izkušnje z OTRS, boste morali omogočiti JavaScript v vašem brskalniku.',
        'In this form you can select the basic specifications.' => 'To je mesto za izbor splošnih podatkov.',
        'In this way you can directly edit the keyring configured in Kernel/Config.pm.' =>
            'NA ta način lahko neposredno uredite ključe vnešene v datoteki "Kernel/Config.pm".',
        'Inbound Mail Password' => 'Geslo vhodne pošte',
        'Inbound Mail Type' => 'Tip vhodne pošte',
        'Inbound Mail User' => 'vhodni mail uporabnika',
        'Inbound Mail host' => 'vhodni mail gostitelja',
        'Information about the Stat' => 'Informacije o statistiki',
        'Insert of the common specifications' => 'Vnos skupnih specifikacij',
        'Instance' => 'Stopnje',
        'Is Job Valid' => 'Ali je delo veljavno',
        'Is Job Valid?' => 'Ali je delo veljavno?',
        'It\'s useful for ASP solutions.' => 'Uporabno za "ASP" rešitve.',
        'Job-List' => 'Seznam del',
        'Keyword' => 'Ključna beseda',
        'Keywords' => 'Ključne besede',
        'Kill session' => 'Prekini sejo',
        ...
        'Linked as' => 'Povezano kot',
        'Load' => 'Naloži',
        'Load Settings' => 'Naloži nastavitve',
        'Lock it to work on it!' => 'Prevzemi zaradi dela na tem zahtevku!',
        'Logfile' => 'Log datoteka',
        'Logfile just needed for File-LogModule!' => 'Log datoteka je obvezna za Modul dnevnika.',
        'Logfile too large, you need to reset it!' => 'Log datoteka je prevelika, potrebno jo je restartati!',
        'Login failed! Your username or password was entered incorrectly.' =>
            'Prijava ni uspela! Vaše uporabniško ime in/ali geslo ste vnesli napačno.',
        'Lookup' => 'Iskanje',
        'Mail Management' => 'Upravljanje z e-pošto',
        ...
        'Misc' => 'Ostalo',
        'Mobile{CustomerUser}' => 'Mobilni (uporabnik)',
        ...
        'New Customer' => 'Novi uporabnik',
        'New Group' => 'Nova skupina',
        'New Group Ro' => 'Nova supina "Ro"',
        'New Password' => 'Novo geslo',
        'New Priority' => 'Nova prioriteta',
        'New SLA' => 'Nova "SLA"',
        'New Service' => 'Nove storitve',
        'New State' => 'Novi statusi',
        'New Ticket Lock' => 'Prevzem novih zahtevkov',
        'New TicketFreeFields' => 'Prosta polja novega zahtevka',
        'New Title' => 'Nov naslov',
        'New Type' => 'Nov tip',
        'New account created. Sent Login-Account to %s.' => 'Ustvarjen nov račun. Podatki za prijavo so poslani na %s.',
        'New messages' => 'Nova sporočila',
        'New password again' => 'Novo geslo (ponovno)',
        'Next Week' => 'Naslednji teden',
        'No * possible!' => 'Ni "*" mogoče!',
        'No Packages for requested Framework in this Online Repository, but Packages for other Frameworks!' =>
            'U mrežnom spremištu nema paketa za traženi sistem, tu su samo paketi za druge verzije.',
        'No Permission' => 'Ni dovolenja',
        'No matches found' => 'Ni zadetkov',
        'No time settings.' => 'Ni nastavitve časa.',
        'Node-Name' => 'Ime vozlišča',
        'Note Text' => 'Besedilo opombe',
        'Notification (Customer)' => 'Obvestilo (uporabnik)',
        'Notifications' => 'Obvestila',
        'OTRS DB Password' => 'OTRS DB geslo',
        'OTRS sends an notification email to the customer if the ticket is moved.' =>
            'OTRS pošilja e-poštna obvestila stranki, če se je zahtevek premaknil.',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' =>
            'OTRS pošilja e-poštna obvestila stranki, če se je lastnik na zahtevku spremenil.',
        'OTRS sends an notification email to the customer if the ticket state has changed.' =>
            'OTRS pošilja e-poštna obvestila stranki, če se je stanje na zahtevku spremenilo.',
        'Object already linked as %s.' => 'Objekt je že povezan kot %s.',
        'Of couse this feature will take some system performance it self!' =>
            'Če je ta funkcija aktivna, zavzame del sistemskih resursov.',
        'One or more errors occured!' => 'Zgodila se je ena ali več napak!',
        'Only for ArticleCreate Event.' => 'Samo za dogodek kreiranja članka.',
        'Open Tickets' => 'Odprti zahtevki',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)' =>
            'Možnosti za tekoče podatke o uporabniku (npr. <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>).' =>
            'Možnosti za tekoče podatke o uporabniku (npr. <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Options of the current user who requested this action (e. g. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)' =>
            'Možnosti za trenutnega uporabnika, ki je zahteval ta ukrep (npr. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)' =>
            'Informacije o aktualnem uporabniku ki je iskal to akcijo (npr. <OTRS_CURRENT_UserFirstname>)',
        'Options of the ticket data (e. g. &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)' =>
            'Možnosti podatkov o zahtevku (npr. &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)',
        'Options of the ticket data (e. g. <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' =>
            'Možnosti podatkov o zahtevku (npr. <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' =>
            'Možnosti podatkov o zahtevku (npr. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Other Options' => 'Druge možnosti',
        'Out Of Office' => 'Izven pisarne',
        'Outbound Mail Type' => 'Tip izhodne pošte',
        'POP3 Account Management' => 'Upravljanje "POP3" računi',
        'Package' => 'Paket',
        ...
        'Param 5' => 'Param 5',
        'Param 6' => 'Param 6',
        'Parent-Object' => 'Matični objekt',
        'Password for Inbound Mail' => 'Geslo za vhodno poštu',
        'Password for SMTP Auth' => 'Geslo za "SMTP" avtentikacijo',
        'Password is already used! Please use an other password!' => 'To geslo se že uporablja, prosimo izberite drugo geslo!',
        'Passwords doesn\'t match! Please try it again!' => 'Gesla se ne ujemajo! Prosimo poiskusite ponovno!',
        'Pending Times' => 'Čas čakanja',
        'Pending messages' => 'Sporočila na čakanju',
        'Pending type' => 'Tip čakanja',
        'Permissions to change the ticket owner in this group/queue.' => 'Dovolenje za spremembo lastnika zahtevka v tej skupini/vrsti.',
        'PhoneView' => 'Pregled telefona',
        'Phone{CustomerUser}' => 'Telefon (uporabnik)',
        'Please command us.' => 'Prosimo za ukaz za delo.',
        ...
        'Product' => 'Izdelek',
        'Queue <-> Auto Responses Management' => 'Vrsta <-> Upravljanje z avtomatskim odgovorom',
        'Queue Management' => 'Upravljanje vrst',
        'Queue is required.' => 'Vrsta je obvezna.',
        'QueueView Refresh Time' => 'Čas osvežitve pregledovanja vrste',
        'Queues <-> Auto Responses' => 'Vrste <-> Avtomatski odgovori',
        'Realname' => 'Pravo ime',
        'Rebuild' => 'Obnovi',
        'Recipients' => 'Prejemniki',
        'Reminder' => 'Opomnik',
        'Reminder messages' => 'Opomnik sporočil',
        'Remove from list of subscribed tickets' => 'Odstrani se s seznama za naročanje zahtevkov',
        'Reporter' => 'Prijavljitelj',
        'Required Field' => 'Obvezno polje',
        'Required!' => 'Obvezno!',
        'Response Management' => 'Upravljanje z odgovori',
        'Responses <-> Attachments Management' => 'Odgovori <-> Upravljanje z priponkami',
        'Responses <-> Queue Management' => 'Odgovori <-> Upravljanje z vrsto',
        'Role' => 'Vloga',
        'Roles <-> Agents' => 'Vloge <-> operaterji',
        'Roles <-> Groups Management' => 'Vloge <-> Upravljanje s skupinami',
        'Roles <-> Users' => 'Vloge <-> Uporabniki',
        'Roles <-> Users Management' => 'Vloge <-> Upravljanje z uporabniki',
        'Run Search' => 'Zaženi iskanje',
        'SMTP Auth Password' => '"SMTP" geslo',
        'Save Job as?' => 'Shrani delo kot?',
        'Save Search-Profile as Template?' => 'Shrani profil iskanja kot predlogo?',
        'Schedule' => 'Razpored',
        'Search Result' => 'Rezultati iskanja',
        'Search Ticket' => 'Iskanje zahtevkov',
        'Search for' => 'Iskanje za',
        'Search for customers (wildcards are allowed).' => 'Iskalnik za uporabnike (Nadomestni znaki so dovoljeni).',
        'Search-Profile as Template?' => 'Profil iskanja kot predloga?',
        'Secure Mode need to be enabled!' => 'Varnostni način mora biti omogočen!',
        'Select Box' => 'Izbirno polje',
        'Select Box Result' => 'Select Box Ergebnis',
        'Select Source (for add)' => 'Izberi izvor (za dodajanje)',
        'Select inbound mail type' => 'Izberi tip vhodne pošte',
        'Select outbound mail type' => 'Izberi tip izhodne pošte',
        'Select the customeruser:service relations.' => 'Izberite Uporabnik:odnos storitve.',
        'Select the element, which will be used at the X-axis' => 'Izberite element, ki bo uporabljen na X-osi.',
        'Select the restrictions to characterise the stat' => 'Izberite omejitve za statistiko',
        'Select the role:user relations.' => 'Izberite vlogo:uporabniške povezave.',
        'Select the user:group permissions.' => 'Izberite uporabnika:dovolenje skupine.',
        'Select your QueueView refresh time.' => 'Izberite čas osvežitve za pregled vrste.',
        'Select your default spelling dictionary.' => 'Izberite privzet slovar za pregled pravopisa.',
        'Select your frontend Charset.' => 'Izberite nabor znakov vmesnika.',
        'Select your frontend QueueView.' => 'Izberite pregled vrste.',
        'Select your frontend language.' => 'Izberite jezik vmesnika.',
        'Select your out of office time.' => 'Izberite vaš izvedelovni čas.',
        'Select your screen after creating a new ticket.' => 'Izberite okno, ki se prikaže po odprtju novega zahtevka.',
        'Selection needed' => 'potreben izbor',
        'Send Administrative Message to Agents' => 'Pošlji administrativno obvestilo zaposlenim.',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.' =>
            'Obvesti me če uporabnik pošlje nadaljevanje zahtevka katerega lastnik sem sam.',
        'Sent new password to: ' => 'Pošlji novo geslo za: ',
        'Sent new password to: %s' => 'Poslano novo geslo za %s.',
        'Sent password reset instructions to %s. Please check your email.' =>
            'Navodila za ponastavitev gesla so poslana na %s. Prosimo preverite vašo E-pošto.',
        'Sent password token to: %s' => 'Poslano geslo za: %s.',
        ...
        'Some result formats are disabled because at least one needed package is not installed. Please contact your administrator.' =>
            'Nekateri formati rezultata so onemogočeni, ker vsaj en potreben paket ni nameščen. Prosimo kontaktirajte vašega administratorja.',
        ...
        'Street{CustomerUser}' => 'Ulica (uporabnik)',
        'Sub-Queue of' => 'Pod-vrsta od',
        'Sub-Service of' => 'Podservis od',
        'Subscribe' => 'Naročite se',
        'System State Management' => 'Upravljanje s sistemskim statusom',
        'System Status' => 'Sistemski status',
        'Systemaddress' => 'Sistemski naslov',
        'Take care that you also updated the default states in you Kernel/Config.pm!' =>
            'Pazite, da boste posodobil tudi privzete statuse v Kernel/Config.pm!',
        'Text is required!' => 'Besedilo je obavezno',
        'The Ticket was locked' => 'Zahtevek je bil prevzet',
        'The User Name you wish to have' => 'Uporabniško ime, ki bi si ga želeli',
        'The customer id is required!' => 'ID uporabnika je obavezen!',
        'The customer is required!' => 'Uporabnik je obavezen!',
        'The customer is required.' => 'Uporabnik je obavezen.',
        'The field is required.' => 'Polje je obvezno.',
        'The identify of the system. Each ticket number and each http session id starts with this number.' =>
            'Identitet sistema. Svaki broj kartice i svaki ID "HTTP" sesije počinje sa ovim brojem.',
        'The message being composed has been closed.  Exiting.' => 'Sporočilo, ki se piše je bilo zaprto.',
        'The subject is required!' => 'Predmet je obavezen!',
        'The subject is required.' => 'Predmet je obavezen.',
        'The text is required!' => 'Tekst je obavezen!',
        'The text is required.' => 'Tekst je obavezen.',
        'These values are read-only.' => 'Te vrednosti so samo za branje.',
        'These values are required.' => 'Te vrednosti so obvezne.',
        'This account exists.' => 'Ta račun ne obstaja.',
        'This email address already exists. Please log in or reset your password..' =>
            'Ta naslov E-pošte že obstaja. Prosimo, prijavite se ali pa resetirajte vašo geslo',
        'This is useful if you want that no one can get the result of the stat or the stat isn\'t ready configurated.' =>
            'To je uporabno če neželite da kdo vidi rezultate statistike ali pa nastavitve statistike niso končane.',
        'Ticket Lock' => 'Prevzem zahtevka',
        'Ticket Number Generator' => 'Generator številke zahtevka',
        'Ticket Search' => 'Iskanje zahtevka',
        'Ticket Status View' => 'Pregled statusa zahtevka',
        'Ticket Type is required!' => 'Tip zahtevka je obavezen!',
        'Ticket escalation!' => 'Eskalacija zahtevka!',
        'Ticket locked!' => 'Zahtevek je prevzet/blokiran',
        'Ticket owner options (e. g. &lt;OTRS_OWNER_USERFIRSTNAME&gt;)' =>
            'Možnosti lastnika kartice (npr. &lt;OTRS_OWNER_USERFIRSTNAME&gt;)',
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>).' => 'Možnosti lastnika kartice (z. B. <OTRS_OWNER_UserFirstname>).',
        'Ticket responsible options (e. g. <OTRS_RESPONSIBLE_UserFirstname>).' =>
            'Možnosti o odgovornosti za zahtevek (z. B.<OTRS_RESPONSIBLE_UserFirstname>).',
        'Ticket selected for bulk action!' => 'zahtevek izabran za masovno akcijo',
        'Ticket type is required.' => 'Tip zahtevka je obavezen.',
        'Ticket unlock!' => 'Odklepanje zahtevka!',
        'Ticket#' => 'zahtevek Št.',
        'Ticket-Area' => 'Prostor zahtevka',
        'TicketFreeFields' => 'Prosta polja v zahtevku',
        'TicketFreeText' => 'TicketFreeText',
        'TicketZoom' => 'Vsebina zahtevka',
        'Tickets available' => 'Zahtevki, ki s na voljo',
        'Tickets shown' => 'Prikazani zahtevki',
        'Tickets which need to be answered!' => 'zahtevki na katere je potrebno odgovoriti!',
        'Time units is a required field!' => 'Časovne enote so obvezno polje.',
        'Time units is a required field.' => 'Časovne enote so obvezno polje.',
        'Time units is required field.' => 'Časovne enote so obvezno polje.',
        'Time1' => 'Čas1',
        'Time2' => 'Čas2',
        'Time3' => 'Čas3',
        'Time4' => 'Čas4',
        ...
        'Title{CustomerUser}' => 'Naslov (uporabnik)',
        'Title{user}' => 'Naslov',
        'To get the article attribute (e. g. (<OTRS_AGENT_From>, <OTRS_AGENT_To>, <OTRS_AGENT_Cc>, <OTRS_AGENT_Subject> and <OTRS_AGENT_Body>).' =>
            'Da bi dobili atribut/lastnost članka (npr. (<OTRS_AGENT_From>, <OTRS_AGENT_To>, <OTRS_AGENT_Cc>, <OTRS_AGENT_Subject> und <OTRS_AGENT_Body>).',
        ...
        'U' => 'U',
        'Unable to parse Online Repository index document!' => 'Ni mogoče razčleniti indeksa spletnega skladišča!',
        'Unlock Tickets' => 'Odkleni zahtevek',
        'Unlock to give it back to the queue!' => 'Odkleni da se vrne nazaj v vrsto!',
        'Unsubscribe' => 'Odjavi se',
        'Use utf-8 it your database supports it!' => 'Uporabljajte "utf-8" samo če ga vaša baza podatkov podpira!',
        'Useable options' => 'Uporabne možnosti',
        'Used default language.' => 'Uporabljen privzet jezik.',
        'Used log backend.' => 'Uporabljena metoda logiranja.',
        'User Management' => 'Upravljanje z uporabniki',
        'User for Inbound Mail' => 'Uporabnik za vhodno e-pošto',
        'User will be needed to handle tickets.' => 'Potrebujete zaposlenega za delo na zahtevku.',
        'User-Name' => 'Uporabniško ime',
        'User-Number' => 'Uporabnik številka',
        'Username for SMTP Auth' => 'Uporabniško ime za "SMTP" avtentikacijo',
        'Username{CustomerUser}' => 'Uporabiško ime (uporabniki)',
        'Users' => 'Uporabniki',
        'Users <-> Groups' => 'Uporabniki <-> Skupine',
        'Users <-> Groups Management' => 'Uporabniki <-> Upravljanje z skupinami',
        'Verify New Password' => 'Potrdi novo geslo',
        'Warning! This tickets will be removed from the database! This tickets are lost!' =>
            'Pozor! Ti zahtevki bodo odstranjeni iz baze in za vedno izgubljeni!',
        'Watch notification' => 'Glejte obvestila',
        'We stop eating if you wish us to do.' => 'Lahko končamo tudi s prehranjevanjem, če vi tako želite.',
        'Web-Installer' => 'Web-namestitev',
        'Welcome to OTRS' => 'Dobrodošli v Storitveni Center MOC',
        'Wildcards are allowed.' => 'Nadomestni znaki so dovoljeni.',
        'With the input and select fields you can configurate the stat at your needs. Which elements of a stat you can edit depends on your stats administrator who configurated the stat.' =>
            'Vnosnim in izbornim poljem lahko nastavie statistiko tako kt si samo želite. Katere elemente statistike lahko menjate je odvisno od nastavitev statistike.',
        'Workflow Groups' => 'Skupine poteka dela',
        'Yes, save it with name' => 'Da, shrani z imenom',
        'You as the customer have the ability to let us support staff people jump around as you wish because it\'s all about you. We stop eating if you wish us to do. Your way to communicate with us is this thing called \'ticket\'. Please command us.' =>
            'Vi kot uporabnik imate privilegije da ste v centru pozornosti osebja tehnične pomoči. naredili bomo vse, da bi bili zadovoljni. Način, da učinkovito komunicirate z nami je stvar, ki se imenuje "zahtevek". Prosimo vas, javite nam Vaš problem.',
        'You got new message!' => 'Imate novo sporočilo!',
        'You have not created a ticket yet.' => 'Zahtevka še niste ustvarili.',
        'You need a to: recipient!.' => 'Prejemnik, polje "Za:" je obvezno!',
        'You need to account time!' => 'Potrebno je obračunati čas!',
        'You need to activate %s first to use it!' => 'Potrebno je aktivirati %s pred uporabo!',
        'Your Password' => 'Vaše geslo',
        'Your email address is new' => 'Vaš naslov E-pošte je nov',
        'Your email with ticket number "<OTRS_TICKET>" is bounced to "<OTRS_BOUNCE_TO>". Contact this address for further information.' =>
            'Vaša E-pošta z zahtevkom št. "<OTRS_TICKET>" je preusmerjena na "<OTRS_BOUNCE_TO>". Tukaj lahko najdete dodatne informacije.',
        'Your own Ticket' => 'Vaš zahtevek',
        'Your way to communicate with us is this thing called \'ticket\'.' =>
            'Vaš način za komunikacijo z nami, je stvar, ki se imenuje \'zahtevek\'',
        'Zip{CustomerUser}' => 'poštna številka (uporabnik)',
        'customer realname' => 'pravo ime uporabnika',
        'delete' => 'izbriši',
        'delete links' => 'Izbriši povezave',
        'down' => 'dol',
        'false' => 'false',
        'for agent firstname' => 'za ime zaposlenega',
        'for agent lastname' => 'za priimek zaposlenega',
        'for agent login' => 'za prijavo zaposlenih',
        'for agent user id' => 'za uporabniški ID zaposlenega',
        'go back' => 'nazaj',
        'kill all sessions' => 'Zapri vse seje',
        'modified' => 'spremenjeno',
        'new ticket' => 'Nov zahtevek',
        'next step' => 'naslednji korak',
        'not rated' => 'ni ocenjeno',
        'not verified' => 'ne preverja',
        'read' => 'preberite',
        'send' => 'Pošlji',
        'sort downward' => 'sortiraj padajoče',
        'sort upward' => 'sortiraj padajoče',
        'tmp_lock' => 'začasna blokada',
        'to get the first 20 character of the subject' => 'da bi dobili prvih 20 znakov predmeta',
        'to get the first 5 lines of the email' => 'da bi dobili prvih 5 vrstic e-pošte',
        'to get the realname of the sender (if given)' => 'dobiti pravo ime pošiljatelja (če je mogoče)',
        'unknown' => 'neznan',
        'unread' => 'neprebrano',
        'up' => 'vključeno',
        'utf8' => '"utf8"',
