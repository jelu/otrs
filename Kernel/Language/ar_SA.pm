...
# --
# $Id: ar_SA.pm,v 1.78.2.2 2012/11/22 06:56:07 mb Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2012-11-21 21:59:29
    ...
    $Self->{Translation} = {
        ...
        'Agent Mailbox' => 'صندوق بريد المشغل',
        'Agent Preferences' => 'إعدادات المشغل',
        'Agent-Area' => 'منطقة-المشغل',
        'All Agents' => 'جميع المشغلين',
        'All customer tickets.' => 'جميع بطاقات العميل',
        'All messages' => 'جميع الرسائل',
        'Answer' => 'الإجابة',
        'Attach' => 'إرفاق',
        'Auto Response From' => 'الرد الآلي من',
        'Can\'t update password, invalid characters!' => 'لا يمكن تحديث كلمة المرور, الحروف غير صحيحة!',
        'Can\'t update password, must be at least %s characters!' => 'لا يمكن تغيير كلمة المرور, على الأقل يجب كتابة %s خانات!',
        'Can\'t update password, needs at least 1 digit!' => 'لا يمكن تحديث كلمة المرور, يجب كتابة خانة واحدة على الأقل',
        'Can\'t update password, needs at least 2 characters!' => 'لا يمكن تحديث كلمة المرور, يجب كتابة خانتين على الأأقل',
        'Can\'t update password, your new passwords do not match! Please try again!' =>
            'لا يمكن تحديث كلمة المرور, كلمتي المرور غير متطابقتان! الرجاء التجربة مرة أخرى',
        ...
        'Compose Answer' => 'إرسال الإجابة',
        'Compose Email' => 'إرسال بريد',
        'Compose Follow up' => 'إرسال إضافة المتابعة',
        'Contact customer' => 'اتصل بالعميل',
        'Create new Phone Ticket' => 'أنشيء بطاقة هاتف جديدة',
        'CreateTicket' => 'أنشيء بطاقة',
        'Customer Move Notify' => 'تنبيه العميل عند نقل البطاقة',
        'Customer User' => 'العميل',
        'Customer User Management' => 'أدارة العملاء',
        'Customer Users' => 'العملاء',
        'Customer Users <-> Groups' => 'العملاء <=> المجموعات',
        'Customer history' => 'تاريخ العميل',
        'Customer user will be needed to have a customer history and to login via customer panel.' =>
            'العملاء مطلوبون لإمكانية الرجوع إلى تاريخ العملاء كم يمكنهم الدخول من شاشة العملاء.',
        'CustomerUser' => 'العميل',
        'D' => 'أقل',
        'Days' => 'أيام',
        ...
        'Escalation time' => 'قت التصعيد',
        'Export Config' => 'تصدير الخصائص',
        'FAQ Search Result' => 'نتيجة البحث في الأسئلة المتكررة',
        'FAQ System History' => 'تاريخ نظام الأسئلة المتكررة',
        'Follow up' => 'المتابعة',
        'Follow up notification' => 'تنبيه المتابعة',
        'Frontend' => 'الواجهة الأمامية',
        'Home' => 'الرئيسية',
        'Image' => 'صورة',
        'Important' => 'مهم جداً',
        'Imported' => 'تم الإستيراد',
        ...
        'Misc' => 'منوع',
        'Modified' => 'تم تعديله',
        'Move notification' => 'تنبيه عند نقل بطاقة',
        'My Queue' => 'قائمتي',
        'MyTickets' => 'بطاقاتي',
        'Name is required!' => 'الإسم مقروء',
        'New Agent' => 'مشغل جديد',
        'New Customer' => 'عميل جديد',
        'New Group' => 'مجموعة جديدة',
        'New Priority' => 'أولوية جديدة',
        'New State' => 'حالة جديدة',
        'New Ticket Lock' => 'إقفال البطاقة الجديدة',
        'New TicketFreeFields' => 'خانات إضافية جديدة للبطاقة',
        'New messages' => 'الرسائل الجديدة',
        'New password again' => 'كلمة المرور الجديدة مرة أخرى',
        'No Permission' => 'لا توجد صلاحيات',
        'No time settings.' => 'بدون خيارات للوقت',
        'Note Text' => 'نص الملاحظة',
        'Notifications' => 'تنبيهات',
        'Open Tickets' => 'البطاقات المفتوحة',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)' =>
            'الخيارات لبيانات العميل الحالي(مثاله <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)' =>
            'الخصائص للمستخدم الحالي الذي طلب هذه العملية (مثاله <OTRS_CURRENT_UserFirstname>)',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' =>
            'خيارات بيانات البطاقة (مثاله <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Other Options' => 'خيارات أخرى',
        'Package not correctly deployed! You should reinstall the Package again!' =>
            'البرنامج الإضافي لم يخزن بشكل صحيح! يجب عليك إعادة تخزينه مرة اخرى',
        'Parent-Object' => 'الكائن-الأساسي',
        'Password is already in use! Please use an other password!' => 'كلمة المرور مستخدمة مسبقاً! الرجاء إستخدام كلمة مرور أخرىى!',
        'Password is already used! Please use an other password!' => 'كلمة المرور مستخدمة مسبقاً! الرجاء إستخدام كلمة مرور أخرى !',
        ...
        'Reminder' => 'التذكير',
        'Reminder messages' => 'رسائل التذكير',
        'Response Management' => 'إدارة الردود',
        'Responses <-> Queue Management' => 'الردود <=> إدارة القوائم',
        'Return to the compose screen' => 'العودة إلى شاشة الإرسال',
        'Save Search-Profile as Template?' => 'احفظ إعدادات البحث؟',
        'Schedule' => 'الجدول',
        'Search Result' => 'نتيجة البحث',
        'Search for' => 'ابحث عن',
        'Select Source (for add)' => 'أختر المصدر (للإضافة)',
        'Select your QueueView refresh time.' => 'حدد وقت تحديث قائمة البطاقات',
        'Select your default spelling dictionary.' => 'أختر المدقق اللغوي الخاص بك',
        'Select your frontend Charset.' => 'أختر الترميز الخاص بالواجهة الأمامية',
        'Select your frontend QueueView.' => 'أختر قائمة البطاقات الخاصة بك بالواجهة الرئيسية.',
        'Select your frontend language.' => 'أختر لغة الواجهة الأمامية',
        'Select your screen after creating a new ticket.' => 'أختر الشاشة للذهاب إليها بعد إنشاء بطاقة جديدة.',
        'Send Notification' => 'إرسال تنبيه',
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.' =>
            'أرسل إلي تنبيه إذاأرسل العميل ملحق متابعة للبطاقة إذا كانت ملك لي.',
        ...
        'Split' => 'فصل',
        'Stats-Area' => 'منطقة-الإحصائات',
        'Sub-Queue of' => 'قائمة فرعية من',
        'Subscribe' => 'مراقبة',
        'System History' => 'تاريخ النظام',
        'Systemaddress' => 'عنوان النظام',
        'These values are read-only.' => 'هذه القيمة للقراءة فقط',
        'These values are required.' => 'هذه القيمة مطلوبة',
        'Ticket Lock' => 'إحتكار البطاقة',
        'Ticket Search' => 'البحث عن بطاقة',
        'Ticket Status View' => 'عرض حالة البطاقات',
        'Ticket escalation!' => 'رفع البطاقة',
        'Ticket locked!' => 'إقفال البطاقة',
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>)' => 'خيارات مالك البطاقة (مثاله <OTRS_OWNER_UserFirstname>)',
        'Ticket selected for bulk action!' => 'تم تحديد البطاقة للتنفيذ الجماعي',
        'Ticket unlock!' => 'فتح البطاقة',
        ...
        'Total hits' => 'عدد التقارير',
        'U' => 'أعلى',
        'Unlock Tickets' => 'فك إرتباط البطاقات',
        'Unlock to give it back to the queue!' => 'أفتح البطاقة لإرجاعها لقائمة البطاقات الخاصة بها!',
        'Unsubscribe' => 'إلغاء المراقبة',
        'User Management' => 'إدارة المستخدمين',
        'User will be needed to handle tickets.' => 'المستخدم مطلوب لمتابعة البطاقات.',
        'User-Name' => 'إسم-المستخدم',
        'Users' => 'المستخدمين',
        'Users <-> Groups' => 'المستخدمين <=> المجموعات',
        'Welcome to OTRS' => 'مرحباً بك في OTRS',
        'Yes, save it with name' => 'نعم, أحفظها مع الإسم',
        'You got new message!' => 'لديك رسالة جديدة!',
        'You have to select two or more attributes from the select field!' =>
            'يجب عليك تحديد عنصرين أو أكثر من القائمة المحددة!',
        'You need min. one selected Ticket!' => 'يجب تحديد بطاقة واحدة على الأقل!',
        'You need to account time!' => 'يجب عليك حساب الوقت!',
        'You need to activate %s first to use it!' => 'يجب عليك تفعيل %s قبل استخدامه!',
        'You use the DELETE option! Take care, all deleted Tickets are lost!!!' =>
            'قمت بإستخدام "حذف" ! جميع البطاقات المحذوفة مسحت بشكل نهائي!!!!',
        'Your email address is new' => 'عنوان بريدك الإلكتروني الآن هي',
        'Your own Ticket' => 'بطاقتك الخاصة بك',
        'down' => 'أسفل',
        'modified' => 'تم تعديله',
        'new ticket' => 'بطاقة جديدة',
        ...
        'read' => 'إقرأ',
        'send' => 'إرسال',
        'sort downward' => 'ترتيب من الأقل للأعلى',
        'sort upward' => 'ترتيب من الأعلى للأقل',
        'unknown' => 'غير معروف',
        'unread' => 'غير مقروء',
        'up' => 'أعلى',
