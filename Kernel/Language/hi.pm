...
# --
# $Id: hi.pm,v 1.23.2.2 2012/11/22 06:57:31 mb Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'To protect your privacy, active or/and remote content has blocked.' =>
            'आपकी गोपनीयता को सुरक्षित करने के लिए,सक्रिय या / और दूरदराज के विषयवस्तु को अवरोधित किया है।',
        ...
        'Adds the one time vacation days for the calendar number 2. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 2 के लिए एक बार अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the one time vacation days for the calendar number 3. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 3 के लिए एक बार अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the one time vacation days for the calendar number 4. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 4 के लिए एक बार अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the one time vacation days for the calendar number 5. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 5 के लिए एक बार अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the one time vacation days for the calendar number 6. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 6 के लिए एक बार अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the one time vacation days for the calendar number 7. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 7 के लिए एक बार अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the one time vacation days for the calendar number 8. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 8 के लिए एक बार अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the one time vacation days for the calendar number 9. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 9 के लिए एक बार अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the permanent vacation days for the calendar number 1. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 1 के लिए स्थायी अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the permanent vacation days for the calendar number 2. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 2 के लिए स्थायी अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the permanent vacation days for the calendar number 3. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 3 के लिए स्थायी अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the permanent vacation days for the calendar number 4. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 4 के लिए स्थायी अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the permanent vacation days for the calendar number 5. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 5 के लिए स्थायी अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the permanent vacation days for the calendar number 6. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 6 के लिए स्थायी अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        'Adds the permanent vacation days for the calendar number 7. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'पंचांग संख्या 7 के लिए स्थायी अवकाश के दिन जोड़ता हैं। 1 से 9 की संख्या के लिए एकल अंक स्वरूप का उपयोग करें(01 - 09 के बजाय )।',
        ...
        'Article free text options shown in the email ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के ईमेल टिकट स्क्रीन में अनुच्छेद मुक्त पाठ विकल्प में दिखाया गया है। संभव व्यवस्थाऐं: 0 = अक्षम, 1 = सक्रिय, 2 = सक्रिय और आवश्यक।',
        'Article free text options shown in the phone ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के फोन टिकट स्क्रीन में अनुच्छेद मुक्त पाठ विकल्प में दिखाया गया है। संभव व्यवस्थाऐं: 0 = अक्षम, 1 = सक्रिय, 2 = सक्रिय और आवश्यक।',
        'Article free text options shown in the ticket compose screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट रचना स्क्रीन में अनुच्छेद मुक्त पाठ विकल्प में दिखाया गया है। संभव व्यवस्थाऐं: 0 = अक्षम, 1 = सक्रिय, 2 = सक्रिय और आवश्यक।',
        'Article free text options shown in the ticket free text screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट मुक्त पाठ स्क्रीन में अनुच्छेद मुक्त पाठ विकल्प में दिखाया गया है। संभव व्यवस्थाऐं: 0 = अक्षम, 1 = सक्रिय, 2 = सक्रिय और आवश्यक।',
        'Article free text options shown in the ticket message screen of the customer interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required. NOTE. If you want to display these fields also in the ticket zoom of the customer interface, you have to enable them in CustomerTicketZoom###AttributesView.' =>
            'ग्राहक अंतरफलक के टिकट संदेश स्क्रीन में अनुच्छेद मुक्त पाठ विकल्प में दिखाया गया है। संभव सेटिंग्स: 0 = अक्षम, 1 = सक्रिय, 2 = सक्रिय और आवश्यक।ध्यान दें.यदि आप इन क्षेत्रों को ग्राहक इंटरफ़ेस के ज़ूम टिकट में भी प्रदर्शित करना चाहते हैं,तो आप उन्हें CustomerTicketZoom###AttributesView में सक्षम कर सकते हैं।',
        'Article free text options shown in the ticket note screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट टिप्पणी स्क्रीन में अनुच्छेद मुक्त पाठ विकल्प में दिखाया गया है। संभव व्यवस्थाऐं: 0 = अक्षम, 1 = सक्रिय, 2 = सक्रिय और आवश्यक।',
        'Article free text options shown in the ticket owner screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट स्वामी स्क्रीन में अनुच्छेद मुक्त पाठ विकल्प में दिखाया गया है। संभव व्यवस्थाऐं: 0 = अक्षम, 1 = सक्रिय, 2 = सक्रिय और आवश्यक।',
        'Article free text options shown in the ticket pending screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट विचाराधीन स्क्रीन में अनुच्छेद मुक्त पाठ विकल्प में दिखाया गया है। संभव व्यवस्थाऐं: 0 = अक्षम, 1 = सक्रिय, 2 = सक्रिय और आवश्यक।',
        'Article free text options shown in the ticket phone outbound screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट फोन आउटबाउंड स्क्रीन में अनुच्छेद मुक्त पाठ विकल्प में दिखाया गया है। संभव व्यवस्थाऐं: 0 = अक्षम, 1 = सक्रिय, 2 = सक्रिय और आवश्यक।',
        'Article free text options shown in the ticket priority screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक में एक जूम टिकट की टिकट प्राथमिकता स्क्रीन में अनुच्छेद मुक्त पाठ विकल्प में दिखाया गया है। संभव व्यवस्थाऐं: 0 = अक्षम, 1 = सक्रिय, 2 = सक्रिय और आवश्यक।',
        ...
        'Defines the default selection of the free key field number 1 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 1 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 10 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 10 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 11 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 11 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 12 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 12 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 13 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 13 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 14 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 14 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 15 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 15 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 16 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 16 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 2 for articles (if more than one option is provided).' =>
            'अनुच्छेदों के लिए मुक्त कुंजी क्षेत्र संख्या 2 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 2 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 2 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 3 for articles (if more than one option is provided).' =>
            'अनुच्छेदों के लिए मुक्त कुंजी क्षेत्र संख्या 3 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 3 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 3 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 4 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 4 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 5 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 5 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 6 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 6 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 7 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 7 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 8 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 8 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free key field number 9 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त कुंजी क्षेत्र संख्या 9 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 1 for articles (if more than one option is provided).' =>
            'अनुच्छेदों के लिए मुक्त पाठ क्षेत्र संख्या 1 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 1 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 1 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 10 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 10 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 11 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 11 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 12 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 12 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 13 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 13 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 14 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 14 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 15 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 15 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 16 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 16 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 2 for articles (if more than one option is provided).' =>
            'अनुच्छेदों के लिए मुक्त पाठ क्षेत्र संख्या 2 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 2 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 2 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 3 for articles (if more than one option is provided).' =>
            'अनुच्छेदों के लिए मुक्त पाठ क्षेत्र संख्या 3 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 3 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 3 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 4 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 4 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 5 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 5 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 6 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 6 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        'Defines the default selection of the free text field number 7 for tickets (if more than one option is provided).' =>
            'टिकटों के लिए मुक्त पाठ क्षेत्र संख्या 7 के तयशुदा चुनाव को परिभाषित करता है(यदि एक से अधिक विकल्प प्रदान की जाती है)।',
        ...
        'Defines the difference from now (in seconds) of the free time field number 2\'s default value.' =>
            'अभी के अंतर (सेकेंड में) से खाली समय क्षेत्र संख्या 2 के तयशुदा मान को परिभाषित करता है।',
        'Defines the difference from now (in seconds) of the free time field number 3\'s default value.' =>
            'अभी के अंतर (सेकेंड में) से खाली समय क्षेत्र संख्या 3 के तयशुदा मान को परिभाषित करता है।',
        'Defines the difference from now (in seconds) of the free time field number 4\'s default value.' =>
            'अभी के अंतर (सेकेंड में) से खाली समय क्षेत्र संख्या 4 के तयशुदा मान को परिभाषित करता है।',
        'Defines the difference from now (in seconds) of the free time field number 5\'s default value.' =>
            'अभी के अंतर (सेकेंड में) से खाली समय क्षेत्र संख्या 5 के तयशुदा मान को परिभाषित करता है।',
        'Defines the difference from now (in seconds) of the free time field number 6\'s default value.' =>
            'अभी के अंतर (सेकेंड में) से खाली समय क्षेत्र संख्या 6 के तयशुदा मान को परिभाषित करता है।',
        'Defines the free key field number 1 for articles to add a new article attribute.' =>
            'अनुच्छेद में एक नई अनुच्छेद विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 1 को परिभाषित करता है।',
        'Defines the free key field number 1 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 1 को परिभाषित करता है।',
        'Defines the free key field number 10 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 10 को परिभाषित करता है।',
        'Defines the free key field number 11 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 11 को परिभाषित करता है।',
        'Defines the free key field number 12 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 12 को परिभाषित करता है।',
        'Defines the free key field number 13 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 13 को परिभाषित करता है।',
        'Defines the free key field number 14 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 14 को परिभाषित करता है।',
        'Defines the free key field number 15 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 15 को परिभाषित करता है।',
        'Defines the free key field number 16 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 16 को परिभाषित करता है।',
        'Defines the free key field number 2 for articles to add a new article attribute.' =>
            'अनुच्छेद में एक नई अनुच्छेद विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 2 को परिभाषित करता है।',
        'Defines the free key field number 2 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 2 को परिभाषित करता है।',
        'Defines the free key field number 3 for articles to add a new article attribute.' =>
            'अनुच्छेद में एक नई अनुच्छेद विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 3 को परिभाषित करता है।',
        'Defines the free key field number 3 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 3 को परिभाषित करता है।',
        'Defines the free key field number 4 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 4 को परिभाषित करता है।',
        'Defines the free key field number 5 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 5 को परिभाषित करता है।',
        'Defines the free key field number 6 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 6 को परिभाषित करता है।',
        'Defines the free key field number 7 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 7 को परिभाषित करता है।',
        'Defines the free key field number 8 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 8 को परिभाषित करता है।',
        'Defines the free key field number 9 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त मुख्य क्षेत्र क्रमांक 9 को परिभाषित करता है।',
        'Defines the free text field number 1 for articles to add a new article attribute.' =>
            'अनुच्छेद में एक नई अनुच्छेद विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 1 को परिभाषित करता है।',
        'Defines the free text field number 1 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 1 को परिभाषित करता है।',
        'Defines the free text field number 10 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 10 को परिभाषित करता है।',
        'Defines the free text field number 11 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 11 को परिभाषित करता है।',
        'Defines the free text field number 12 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 12 को परिभाषित करता है।',
        'Defines the free text field number 13 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 13 को परिभाषित करता है।',
        'Defines the free text field number 14 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 14 को परिभाषित करता है।',
        'Defines the free text field number 15 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 15 को परिभाषित करता है।',
        'Defines the free text field number 16 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 16 को परिभाषित करता है।',
        'Defines the free text field number 2 for articles to add a new article attribute.' =>
            'अनुच्छेद में एक नई अनुच्छेद विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 2 को परिभाषित करता है।',
        'Defines the free text field number 2 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 2 को परिभाषित करता है।',
        'Defines the free text field number 3 for articles to add a new article attribute.' =>
            'अनुच्छेद में एक नई अनुच्छेद विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 3 को परिभाषित करता है।',
        'Defines the free text field number 3 for ticket to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 3 को परिभाषित करता है।',
        'Defines the free text field number 4 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 4 को परिभाषित करता है।',
        'Defines the free text field number 5 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 5 को परिभाषित करता है।',
        'Defines the free text field number 6 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 6 को परिभाषित करता है।',
        'Defines the free text field number 7 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 7 को परिभाषित करता है।',
        'Defines the free text field number 8 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 8 को परिभाषित करता है।',
        'Defines the free text field number 9 for tickets to add a new ticket attribute.' =>
            'टिकटों में एक नई टिकट विशेषता को जोड़ने के लिए मुक्त पाठ क्षेत्र क्रमांक 9 को परिभाषित करता है।',
        'Defines the free time key field number 1 for tickets.' => 'टिकटों के लिए खाली समय मुख्य क्षेत्र क्रमांक 1 को परिभाषित करता है।',
        'Defines the free time key field number 2 for tickets.' => 'टिकटों के लिए खाली समय मुख्य क्षेत्र क्रमांक 2 को परिभाषित करता है।',
        'Defines the free time key field number 3 for tickets.' => 'टिकटों के लिए खाली समय मुख्य क्षेत्र क्रमांक 3 को परिभाषित करता है।',
        'Defines the free time key field number 4 for tickets.' => 'टिकटों के लिए खाली समय मुख्य क्षेत्र क्रमांक 4 को परिभाषित करता है।',
        'Defines the free time key field number 5 for tickets.' => 'टिकटों के लिए खाली समय मुख्य क्षेत्र क्रमांक 5 को परिभाषित करता है।',
        'Defines the free time key field number 6 for tickets.' => 'टिकटों के लिए खाली समय मुख्य क्षेत्र क्रमांक 6 को परिभाषित करता है।',
        'Defines the hours and week days of the calendar number 1, to count the working time.' =>
            'पंचांग  क्रमांक 1 के घंटे और सप्ताह के दिनों को परिभाषित करता है,कार्य समय की गणना करने के लिए।',
        'Defines the hours and week days of the calendar number 2, to count the working time.' =>
            'पंचांग  क्रमांक 2 के घंटे और सप्ताह के दिनों को परिभाषित करता है,कार्य समय की गणना करने के लिए।',
        'Defines the hours and week days of the calendar number 3, to count the working time.' =>
            'पंचांग  क्रमांक 3 के घंटे और सप्ताह के दिनों को परिभाषित करता है,कार्य समय की गणना करने के लिए।',
        'Defines the hours and week days of the calendar number 4, to count the working time.' =>
            'पंचांग  क्रमांक 4 के घंटे और सप्ताह के दिनों को परिभाषित करता है,कार्य समय की गणना करने के लिए।',
        'Defines the hours and week days of the calendar number 5, to count the working time.' =>
            'पंचांग  क्रमांक 5 के घंटे और सप्ताह के दिनों को परिभाषित करता है,कार्य समय की गणना करने के लिए।',
        'Defines the hours and week days of the calendar number 6, to count the working time.' =>
            'पंचांग  क्रमांक 6 के घंटे और सप्ताह के दिनों को परिभाषित करता है,कार्य समय की गणना करने के लिए।',
        'Defines the hours and week days of the calendar number 7, to count the working time.' =>
            'पंचांग  क्रमांक 7 के घंटे और सप्ताह के दिनों को परिभाषित करता है,कार्य समय की गणना करने के लिए।',
        'Defines the hours and week days of the calendar number 8, to count the working time.' =>
            'पंचांग  क्रमांक 8 के घंटे और सप्ताह के दिनों को परिभाषित करता है,कार्य समय की गणना करने के लिए।',
        'Defines the hours and week days of the calendar number 9, to count the working time.' =>
            'पंचांग  क्रमांक 9 के घंटे और सप्ताह के दिनों को परिभाषित करता है,कार्य समय की गणना करने के लिए।',
        'Defines the http link for the free text field number 1 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 1 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 10 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 10 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 11 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 11 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 12 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 12 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 13 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 13 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 14 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 14 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 15 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 15 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 16 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 16 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 2 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 2 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 3 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 3 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 4 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 4 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 5 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 5 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 6 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 6 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 7 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 7 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 8 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 8 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the http link for the free text field number 9 for tickets (it will be used in every ticket view).' =>
            'टिकटों के मुक्त पाठ क्षेत्र क्रमांक 9 के लिए http लिंक को परिभाषित करता है(यह हर टिकट दृश्य में उपयोग किया जाएगा)।',
        'Defines the list of online repositories. Another installations can be used as repositoriy, for example: Key="http://example.com/otrs/public.pl?Action=PublicRepository;File=" and Content="Some Name".' =>
            'ऑनलाइन भंडार की सूची को परिभाषित करता है। अन्य स्थापनाओं को भंडार के रूप में इस्तेमाल किया जा सकता है,उदाहरण के लिए: कुंजी = "http://example.com/otrs/public.pl?Action=PublicRepository;फ़ाइल = "और सामग्री =" कुछ नाम "।',
        'Defines the name of the calendar number 1.' => 'पंचांग  क्रमांक 1 के नाम को परिभाषित करता है।',
        'Defines the name of the calendar number 2.' => 'पंचांग  क्रमांक 2 के नाम को परिभाषित करता है।',
        'Defines the name of the calendar number 3.' => 'पंचांग  क्रमांक 3 के नाम को परिभाषित करता है।',
        'Defines the name of the calendar number 4.' => 'पंचांग  क्रमांक 4 के नाम को परिभाषित करता है।',
        'Defines the name of the calendar number 5.' => 'पंचांग  क्रमांक 5 के नाम को परिभाषित करता है।',
        'Defines the name of the calendar number 6.' => 'पंचांग  क्रमांक 6 के नाम को परिभाषित करता है।',
        'Defines the name of the calendar number 7.' => 'पंचांग  क्रमांक 7 के नाम को परिभाषित करता है।',
        'Defines the name of the calendar number 8.' => 'पंचांग  क्रमांक 8 के नाम को परिभाषित करता है।',
        'Defines the name of the calendar number 9.' => 'पंचांग  क्रमांक 9 के नाम को परिभाषित करता है।',
        'Defines the time zone of the calendar number 1, which can be assigned later to a specific queue.' =>
            'पंचांग  क्रमांक 1 के समय क्षेत्र को परिभाषित करता है,जो कि एक विशिष्ट श्रेणी को बाद में सौंपा जा सकता है।',
        'Defines the time zone of the calendar number 2, which can be assigned later to a specific queue.' =>
            'पंचांग  क्रमांक 2 के समय क्षेत्र को परिभाषित करता है,जो कि एक विशिष्ट श्रेणी को बाद में सौंपा जा सकता है।',
        'Defines the time zone of the calendar number 3, which can be assigned later to a specific queue.' =>
            'पंचांग  क्रमांक 3 के समय क्षेत्र को परिभाषित करता है,जो कि एक विशिष्ट श्रेणी को बाद में सौंपा जा सकता है।',
        'Defines the time zone of the calendar number 4, which can be assigned later to a specific queue.' =>
            'पंचांग  क्रमांक 4 के समय क्षेत्र को परिभाषित करता है,जो कि एक विशिष्ट श्रेणी को बाद में सौंपा जा सकता है।',
        'Defines the time zone of the calendar number 5, which can be assigned later to a specific queue.' =>
            'पंचांग  क्रमांक 5 के समय क्षेत्र को परिभाषित करता है,जो कि एक विशिष्ट श्रेणी को बाद में सौंपा जा सकता है।',
        'Defines the time zone of the calendar number 6, which can be assigned later to a specific queue.' =>
            'पंचांग  क्रमांक 6 के समय क्षेत्र को परिभाषित करता है,जो कि एक विशिष्ट श्रेणी को बाद में सौंपा जा सकता है।',
        'Defines the time zone of the calendar number 7, which can be assigned later to a specific queue.' =>
            'पंचांग  क्रमांक 7 के समय क्षेत्र को परिभाषित करता है,जो कि एक विशिष्ट श्रेणी को बाद में सौंपा जा सकता है।',
        'Defines the time zone of the calendar number 8, which can be assigned later to a specific queue.' =>
            'पंचांग  क्रमांक 8 के समय क्षेत्र को परिभाषित करता है,जो कि एक विशिष्ट श्रेणी को बाद में सौंपा जा सकता है।',
        'Defines the time zone of the calendar number 9, which can be assigned later to a specific queue.' =>
            'पंचांग  क्रमांक 9 के समय क्षेत्र को परिभाषित करता है,जो कि एक विशिष्ट श्रेणी को बाद में सौंपा जा सकता है।',
        'Defines the years (in future and in past) which can get selected in free time field number 1.' =>
            'वर्ष(भविष्य में और अतीत में) जो खाली समय क्षेत्र क्रमांक 1 में चयनित हो सकते हैं उनको परिभाषित करता है।',
        'Defines the years (in future and in past) which can get selected in free time field number 2.' =>
            'वर्ष(भविष्य में और अतीत में) जो खाली समय क्षेत्र क्रमांक 2 में चयनित हो सकते हैं उनको परिभाषित करता है।',
        'Defines the years (in future and in past) which can get selected in free time field number 3.' =>
            'वर्ष(भविष्य में और अतीत में) जो खाली समय क्षेत्र क्रमांक 3 में चयनित हो सकते हैं उनको परिभाषित करता है।',
        'Defines the years (in future and in past) which can get selected in free time field number 4.' =>
            'वर्ष(भविष्य में और अतीत में) जो खाली समय क्षेत्र क्रमांक 4 में चयनित हो सकते हैं उनको परिभाषित करता है।',
        'Defines the years (in future and in past) which can get selected in free time field number 5.' =>
            'वर्ष(भविष्य में और अतीत में) जो खाली समय क्षेत्र क्रमांक 5 में चयनित हो सकते हैं उनको परिभाषित करता है।',
        'Defines the years (in future and in past) which can get selected in free time field number 6.' =>
            'वर्ष(भविष्य में और अतीत में) जो खाली समय क्षेत्र क्रमांक 6 में चयनित हो सकते हैं उनको परिभाषित करता है।',
        'Defines whether the free time field number 1 is optional or not.' =>
            'खाली समय क्षेत्र क्रमांक 1 वैकल्पिक है या नहीं को परिभाषित करता है।',
        'Defines whether the free time field number 2 is optional or not.' =>
            'खाली समय क्षेत्र क्रमांक 2 वैकल्पिक है या नहीं को परिभाषित करता है।',
        'Defines whether the free time field number 3 is optional or not.' =>
            'खाली समय क्षेत्र क्रमांक 3 वैकल्पिक है या नहीं को परिभाषित करता है।',
        'Defines whether the free time field number 4 is optional or not.' =>
            'खाली समय क्षेत्र क्रमांक 4 वैकल्पिक है या नहीं को परिभाषित करता है।',
        'Defines whether the free time field number 5 is optional or not.' =>
            'खाली समय क्षेत्र क्रमांक 5 वैकल्पिक है या नहीं को परिभाषित करता है।',
        ...
        'The logo shown in the header of the agent interface. The URL to the image must be a relative URL to the skin image directory.' =>
            'प्रतिनिधि अंतरफलक के शीर्षक में दिखाया गया प्रतीक चिह्न। छवि के लिए URL सतही की छवि निर्देशिका के कोई सापेक्ष URL होना चाहिए।',
        'The logo shown in the header of the customer interface. The URL to the image must be a relative URL to the skin image directory.' =>
            'ग्राहक अंतरफलक के शीर्षक में दिखाया गया प्रतीक चिह्न। छवि के लिए URL सतही की छवि निर्देशिका के कोई सापेक्ष URL होना चाहिए।',
        'Ticket free text options shown in the close ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के बंद टिकट स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the email ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के ईमेल टिकट स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the move ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के स्थानांतरण टिकट स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the phone ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के फोन टिकट स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the ticket compose screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट रचना स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the ticket forward screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट अग्रेषण स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the ticket free text screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट मुक्त पाठ स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the ticket message screen of the customer interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required. NOTE. If you want to display these fields also in the ticket zoom of the customer interface, you have to enable them in CustomerTicketZoom###AttributesView.' =>
            'ग्राहक अंतरफलक के टिकट संदेश स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक। ध्यान दें. यदि आप इन क्षेत्रों को ग्राहक अंतरफलक के टिकट ज़ूम में भी प्रदर्शित करना चाहते हैं,आपको उन्हें CustomerTicketZoom###AttributesView में सक्रिय करना होगा।',
        'Ticket free text options shown in the ticket note screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट टिप्पणी स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the ticket owner screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के ज़ूम टिकट के टिकट स्वामी स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the ticket pending screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के ज़ूम टिकट के टिकट विचाराधीन स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the ticket phone outbound screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के ज़ूम टिकट के टिकट फोन आउटबाउंड स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the ticket priority screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के ज़ूम टिकट के टिकट प्राथमिकता स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the ticket responsible screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट उत्तरदायी स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the ticket search of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट खोजें में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free text options shown in the ticket search screen in the customer interface. Possible settings: 0 = Disabled and 1 = Enabled.' =>
            'प्रतिनिधि अंतरफलक के टिकट खोजें स्क्रीन में दिखाए गए टिकट मुक्त पाठ विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the close ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के बंद टिकट स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the email ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के ईमेल टिकट स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the move ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के स्थानांतरण टिकट स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the phone ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के फोन टिकट स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the ticket compose screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट रचना स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the ticket forward screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट अग्रेषण स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the ticket free text screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट मुक्त पाठ स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the ticket message screen of the customer interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required. NOTE. If you want to display these fields also in the ticket zoom of the customer interface, you have to enable them in CustomerTicketZoom###AttributesView.' =>
            'ग्राहक अंतरफलक के टिकट संदेश स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक। ध्यान दें. यदि आप इन क्षेत्रों को ग्राहक अंतरफलक के टिकट ज़ूम में भी प्रदर्शित करना चाहते हैं,आपको उन्हें CustomerTicketZoom###AttributesView में सक्रिय करना होगा।',
        'Ticket free time options shown in the ticket note screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट टिप्पणी स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the ticket owner screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के ज़ूम टिकट के टिकट स्वामी स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the ticket pending screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के ज़ूम टिकट के टिकट विचाराधीन स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the ticket phone outbound screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के ज़ूम टिकट के टिकट फोन आउटबाउंड स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the ticket priority screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के ज़ूम टिकट के टिकट प्राथमिकता स्क्रीन में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the ticket responsible screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            'प्रतिनिधि अंतरफलक के टिकट उत्तरदायी स्क्रीन में दिखाए गए टिकट मुक्त पाठ समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय,2=सक्रिय और आवश्यक।',
        'Ticket free time options shown in the ticket search of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.' =>
            'प्रतिनिधि अंतरफलक के टिकट खोजें में दिखाए गए टिकट मुक्त समय विकल्प। संभावित व्यवस्थाऐं:0=निष्क्रिय,1=सक्रिय।',
