...
# --
# $Id: hr.pm,v 1.21.2.2 2012/11/22 06:57:31 mb Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'To protect your privacy, active or/and remote content has blocked.' =>
            'Zbog zaštite vaše privatnosti, aktivni ili/i udaljeni sadržaj je blokiran.',
        ...
        #
        '%s Tickets affected! Do you really want to use this job?' => '%s kartice zahvaćeno! Da li stvarno želite da pokrenete ovaj posao?',
        '(Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behinde a dial-up line $!)' =>
            '(Proverite "MX" zapise upotrebljenih adresa E-pošte kreiranjem odgovora. Nemojte koristiti ovu funkciju ako je vaš OTRS server na "dial-up" liniji!)',
        '(Email of the system admin)' => '(E-pošta administratora sustava)',
        '(Full qualified domain name of your system)' => '(Puno kvalifikovano ime domena vašeg sistema)',
        '(Note: It depends on your installation how many dynamic objects you can use)' =>
            '(Napomena: Od vaše instalacije zavisi broj dinamičkih objekata koje možete koristiti)',
        '(Ticket identifier. Some people want toset this to e. g. \'Ticket#\', \'Call#\' or \'MyTicket#\')' =>
            '(Identifikacija kartice. npr. \'Ticket#\', \'Call#\' ili \'MyTicket#\')',
        '(Used default language)' => '(Zadani jezik korisnika)',
        '(Used ticket number format)' => '(Upotrebljeni format za broj kartice)',
        'A article should have a title!' => 'Članak treba da ima naslov!',
        ...
        'A message should have a body!' => 'Poruka treba da sadrži neki tekst!',
        ...
        'Add a new Customer Company.' => 'Dodaj novu korisničku tvrtku.',
        ...
        'Admin-password' => 'Administratorska lozinka',
        'Agent Mailbox' => 'Poštansko sanduče zaposlenih',
        'Agent Preferences' => 'Podešavanja zaposlenog',
        ...
        'All Customer variables like defined in config option CustomerUser.' =>
            'Sve korisničke varijable kao što su definirane u konfiguracijskim opcijama za korisnika.',
        'All customer tickets.' => 'Svi kartice za korisnika.',
        'All email addresses get excluded on replaying on composing an email.' =>
            'Sve adrese E-pošte će biti isključene pri kreiranju odgovora.',
        ...
        'Answer' => 'Odgovor',
        'Article Create Times' => 'Vremena kreiranja članka',
        'Article created' => 'Kreiran članak',
        'Article created between' => 'Članak kreiran između',
        ...
        'Bounce ticket' => 'Preusmjeri karticu',
        'CSV' => 'CSV',
        'Can not create link with %s!' => 'Ne može se napraviti veza sa %s!',
        'Can not delete link with %s!' => 'Veza sa %s se ne može obrisati!',
        'Can\'t update password, must be at least %s characters!' => 'Lozinka se ne može ažurirati, mora biti duga najmanje %s znakova.',
        'Can\'t update password, must contain 2 lower and 2 upper characters!' =>
            'Lozinka se ne može ažurirati. Mora da sadrži najmanje dva mala i dva velika slova.',
        'Can\'t update password, needs at least 1 digit!' => 'Lozinka se ne može ažurirati, neophodno je da sadrži bar jednu cifru!',
        'Can\'t update password, needs at least 2 characters!' => 'Lozinka se ne može ažurirati. Nedostaju najmanje dva znaka!',
        'Can\'t update password, your new passwords do not match! Please try again!' =>
            'Lozinka se ne može ažurirati, nova lozinka se ne podudara! Molimo pokušajte ponovo!',
        'Category Tree' => 'Stablo kategorija',
        'Cc: (%s) added database email!' => 'Kk: (%s) dodana adresa E-pošte iz baze!',
        ...
        'Check Mail Configuration' => 'Provjeri konfiguraciju E-pošte',
        ...
        'Compose Answer' => 'Napiši odgovor',
        'Compose Email' => 'Napiši poruku E-pošte',
        ...
        'Country{CustomerUser}' => 'Država (korisnik)',
        ...
        'Create/Expires' => 'Kreiran/Ističe',
        'CreateTicket' => 'Otvaranje kartice',
        'Current Impact Rating' => 'Ocjena trenutnog utjecaja',
        'Customer Move Notify' => 'Obavijesti o premještaju korisnika',
        'Customer User' => 'Korisnik',
        ...
        'Customer history search' => 'Pretraživanje istorijata za korisnika',
        ...
        'Customer item (icon) which shows the open tickets of this customer as info block.' =>
            'Korisnička stavka (ikona) koja pokazuje otvorene kartice ovog korisnika kao info blok.',
        ...
        'Default Language' => 'Zadani jezik',
        'Default skin for otrs 3.0 interface.' => 'Zadani izgled OTRS 3.0 sučelja.',
        'Defines the default selection of the free key field number 1 for articles (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 1 za članke (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 1 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 1 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 10 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 10 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 11 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 11 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 12 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 12 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 13 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 13 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 14 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 14 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 15 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 15 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 16 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 16 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 2 for articles (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 2 za članke (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 2 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 2 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 3 for articles (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 3 za članke (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 3 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 3 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 4 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 4 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 5 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 5 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 6 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 6 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 7 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 7 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 8 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 8 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free key field number 9 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog ključa polja broj 9 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 1 for articles (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 1 za članke (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 1 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 1 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 10 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 10 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 11 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 11 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 12 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 12 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 13 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 13 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 14 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 14 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 15 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 15 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 16 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 16 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 2 for articles (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 2 za članke (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 2 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 2 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 3 for articles (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 3 za članke (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 3 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 3 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 4 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 4 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 5 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 5 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 6 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 6 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 7 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 7 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 8 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 8 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the default selection of the free text field number 9 for tickets (if more than one option is provided).' =>
            'Određuje zadani izbor slobodnog tekst polja broj 9 za karticue (ako ima više od jedne mogućnosti).',
        'Defines the free key field number 1 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno polje ključa broj 1 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 1 for articles to add a new article attribute.' =>
            'Određuje slobodno tekst polje broj 1 za članke radi dodavanja novog atributa članka.',
        'Defines the free text field number 1 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 1 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 10 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 10 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 11 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 11 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 12 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 12 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 13 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 13 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 14 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 14 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 15 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 15 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 16 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 16 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 2 for articles to add a new article attribute.' =>
            'Određuje slobodno tekst polje broj 2 za članke radi dodavanja novog atributa članka.',
        'Defines the free text field number 2 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 2 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 3 for articles to add a new article attribute.' =>
            'Određuje slobodno tekst polje broj 3 za članke radi dodavanja novog atributa članka.',
        'Defines the free text field number 3 for ticket to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 3 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 4 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 4 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 5 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 5 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 6 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 6 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 7 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 7 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 8 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 8 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free text field number 9 for tickets to add a new ticket attribute.' =>
            'Određuje slobodno tekst polje broj 9 za karticue radi dodavanja novog atributa kartice.',
        'Defines the free time key field number 1 for tickets.' => 'Određuje slobodno polje ključa vremena broj 1 za karticue.',
        'Defines the free time key field number 2 for tickets.' => 'Određuje slobodno polje ključa vremena broj 2 za karticue.',
        'Defines the free time key field number 3 for tickets.' => 'Određuje slobodno polje ključa vremena broj 3 za karticue.',
        'Defines the free time key field number 4 for tickets.' => 'Određuje slobodno polje ključa vremena broj 4 za karticue.',
        'Defines the free time key field number 5 for tickets.' => 'Određuje slobodno polje ključa vremena broj 5 za karticue.',
        'Defines the free time key field number 6 for tickets.' => 'Određuje slobodno polje ključa vremena broj 6 za karticue.',
        'Defines the hours and week days of the calendar number 1, to count the working time.' =>
            'Određuje sate i dane u sedmici za kalendar broj 1, radi kalkulacija radnog vremena.',
        'Defines the hours and week days of the calendar number 2, to count the working time.' =>
            'Određuje sate i dane u sedmici za kalendar broj 2, radi kalkulacija radnog vremena.',
        'Defines the hours and week days of the calendar number 3, to count the working time.' =>
            'Određuje sate i dane u sedmici za kalendar broj 3, radi kalkulacija radnog vremena.',
        'Defines the hours and week days of the calendar number 4, to count the working time.' =>
            'Određuje sate i dane u sedmici za kalendar broj 4, radi kalkulacija radnog vremena.',
        'Defines the hours and week days of the calendar number 5, to count the working time.' =>
            'Određuje sate i dane u sedmici za kalendar broj 5, radi kalkulacija radnog vremena.',
        'Defines the hours and week days of the calendar number 6, to count the working time.' =>
            'Određuje sate i dane u sedmici za kalendar broj 6, radi kalkulacija radnog vremena.',
        'Defines the hours and week days of the calendar number 7, to count the working time.' =>
            'Određuje sate i dane u sedmici za kalendar broj 7, radi kalkulacija radnog vremena.',
        'Defines the hours and week days of the calendar number 8, to count the working time.' =>
            'Određuje sate i dane u sedmici za kalendar broj 8, radi kalkulacija radnog vremena.',
        'Defines the hours and week days of the calendar number 9, to count the working time.' =>
            'Određuje sate i dane u sedmici za kalendar broj 9, radi kalkulacija radnog vremena.',
        'Defines the http link for the free text field number 1 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 1 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 10 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 10 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 11 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 11 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 12 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 12 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 13 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 13 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 14 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 14 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 15 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 15 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 16 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 16 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 2 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 2 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 3 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 3 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 4 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 4 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 5 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 5 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 6 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 6 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 7 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 7 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 8 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 8 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the http link for the free text field number 9 for tickets (it will be used in every ticket view).' =>
            'Određuje "http" vezu za polje slobodnog teksta broj 9 za karticue (biše korišteno u svakom pregledu kartice).',
        'Defines the name of the calendar number 1.' => 'Određuje naziv kalendara broj 1.',
        'Defines the name of the calendar number 2.' => 'Određuje naziv kalendara broj 2.',
        'Defines the name of the calendar number 3.' => 'Određuje naziv kalendara broj 3.',
        'Defines the name of the calendar number 4.' => 'Određuje naziv kalendara broj 4.',
        'Defines the name of the calendar number 5.' => 'Određuje naziv kalendara broj 5.',
        'Defines the name of the calendar number 6.' => 'Određuje naziv kalendara broj 6.',
        'Defines the name of the calendar number 7.' => 'Određuje naziv kalendara broj 7.',
        'Defines the name of the calendar number 8.' => 'Određuje naziv kalendara broj 8.',
        'Defines the name of the calendar number 9.' => 'Određuje naziv kalendara broj 9.',
        'Defines whether the free time field number 1 is optional or not.' =>
            'Određuje da li je slobodno polje vremena broj 1 opciono ili ne.',
        'Defines whether the free time field number 2 is optional or not.' =>
            'Određuje da li je slobodno polje vremena broj 2 opciono ili ne.',
        'Defines whether the free time field number 3 is optional or not.' =>
            'Određuje da li je slobodno polje vremena broj 3 opciono ili ne.',
        'Defines whether the free time field number 4 is optional or not.' =>
            'Određuje da li je slobodno polje vremena broj 4 opciono ili ne.',
        'Defines whether the free time field number 5 is optional or not.' =>
            'Određuje da li je slobodno polje vremena broj 5 opciono ili ne.',
        ...
        'Download Settings' => 'Preuzmite podešavanja',
        'Drop Database' => 'Obriši bazu podataka',
        'Dynamic-Object' => 'Dinamički objekat',
        'Edit Customers' => 'Uredi korisnike',
        'Edit default services.' => 'Uredi podrazumevane servise.',
        'Email based' => 'Na osnovi E-pošte',
        'Email of the system admin.' => 'Adresa E-pošte administratora sistema.',
        'Email{CustomerUser}' => 'Korisnik (E-pošta)',
        'Escalation - First Response Time' => 'Eskalacija - Vreme reakcije',
        'Escalation - Solution Time' => 'Eskalacija - Vrijeme rešavanja',
        'Escalation - Update Time' => 'Eskalacija - Vrijeme ažuriranja',
        'Escalation Times' => 'Vremena eskalacije',
        'Escalation time' => 'Vrijeme eskalacije',
        'Event is required!' => 'Događaj je obavezan!',
        'Explanation' => 'Objašnjenje',
        'Export Config' => 'Izvoz konfiguracije',
        'FAQ Search Result' => 'Rezultat pretrage ČPP',
        'FAQ System History' => 'Dnevnik ČPP sustava',
        ...
        'For very complex stats it is possible to include a hardcoded file.' =>
            'Za veoma složene statistike moguće je pridružiti namenski programiranu datoteku.',
        'Forward ticket: ' => 'Proslijedi karticu',
        'Foward ticket: ' => 'Proslijedi karticu',
        'Frontend' => 'Sučelje',
        'Full qualified domain name of your system.' => 'Puno kvalificirani domenski naziv vašeg sustava npr "otrs-server.example.org"',
        'Go' => 'Idi',
        ...
        'Hash/Fingerprint' => '"Hash"/Sažetak',
        'Have a lot of fun!' => 'Uživajte!',
        'Have you lost your password?' => 'Da li ste izgubili vašu lozinku?',
        'Help' => 'Pomoć',
        'Here you can define the x-axis. You can select one element via the radio button. If you make no selection all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' =>
            'Ovde možete podesiti X osu. Možete izabrati jedan element od ponuđenih opcija. Ukoliko ništa ne izaberete, svi elementi će biti upotrtebljeni ako pravite statistiku. Takođe, novi atribut je dodan nakon poslednje konfiguracije.',
        'Here you can insert a description of the stat.' => 'Ovde možete uneti opis statistike.',
        'Here you can select the dynamic object you want to use.' => 'Ovde možete izabrati dinamičke objekte koje želite da koristite.',
        'Home' => 'Početna',
        'If a new hardcoded file is available this attribute will be shown and you can select one.' =>
            'Ako je nova programirana datoteka dostupna, ovaj atribut će biti prikazan i moći ćete da izaberete jedan.',
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.' =>
            'Ako je karticu zatvoren, a korisnik pošalje nastavak, karticu će biti zaključan za starog vlasnika.',
        'If a ticket will not be answered in this time, just only this ticket will be shown.' =>
            'Ako neće biti odgovoreno na karticu u ovom vremenu, onda će samo ovaj karticu biti prikazan.',
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.' =>
            'Ako zaposlenik zaključa karticu i ne odgovori za ovo vrijeme, kartica će automatski biti otključana. Ta kartica je onda vidljiva svim drugim zaposlenicima.',
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).' =>
            'Ako ništa nije izabrano, onda nema ni dozvola u ovoj grupi (kartice neće biti dostupni za korisnika).',
        ...
        'Imported by' => 'Uvezao',
        'In order to experience OTRS, you\'ll need to enable Javascript in your browser.' =>
            'Kako bi ste maksimalno iskoristili sve mogućnosti OTRS sistema, potrebno je da aktivrate Java skript u vašem Web čitaču.',
        'In this form you can select the basic specifications.' => 'Ovo je mesto za izbor opštih podataka.',
        'In this way you can directly edit the keyring configured in Kernel/Config.pm.' =>
            'Na ovaj način možete neposredno urediti ključeve podešene u datoteci "Kernel/Config.pm".',
        'Inbound Mail Password' => 'Lozinka dolazne pošte',
        'Inbound Mail Type' => 'Tip dolazne pošte',
        'Inbound Mail User' => 'Primalac pošte',
        'Inbound Mail host' => 'računar domaćin dolazne pošte',
        'Information about the Stat' => 'Informacije o statistici',
        'Insert of the common specifications' => 'Unos opštih podataka',
        'Instance' => 'Instanca',
        'Is Job Valid' => 'Da li je posao važeći',
        'Is Job Valid?' => 'Da li je posao važeći?',
        ...
        'Load' => 'Učitaj',
        'Load Settings' => 'Učitaj podešavanja',
        'Lock it to work on it!' => 'Zaključaj radi ekskluzivne obrade!',
        'Logfile' => 'Dnevnik',
        ...
        'Login failed! Your username or password was entered incorrectly.' =>
            'Neuspješna prijava! Vaše korisničko ime i/ili lozinka su netočno unijeti.',
        'Lookup' => 'Pronalaženje',
        'Mail Management' => 'Upravljanje poštom',
        ...
        'Modified' => 'Mijenjano',
        'Modules' => 'Moduli',
        'Move notification' => 'Premeštanje obaveštenja',
        'Multiple selection of the output format.' => 'Višestruki izbor izlaznog formata.',
        'My Queue' => 'Moj red',
        'MyTickets' => 'Moji kartice',
        'Name is required!' => 'Ime je obavezno!',
        'Need a valid email address or don\'t use a local address!' => 'Neophodna je ispravna adresa E-pošte ili nemojte koristiti lokalnu adresu!',
        ...
        'New Ticket Lock' => 'Zaključavanje novih kartice',
        ...
        'Notification (Customer)' => 'Obaveštenje (korisnik)',
        'Notifications' => 'Obaveštenja',
        'OTRS DB Password' => 'OTRS BP Lozinka',
        'OTRS sends an notification email to the customer if the ticket is moved.' =>
            'OTRS šalje obaveštenje korisniku ako je karticu premešten.',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' =>
            'OTRS šalje obavijest korisniku ako je promijenjen vlasnik kartice.',
        'OTRS sends an notification email to the customer if the ticket state has changed.' =>
            'OTRS šalje E-poštu sa obaveštenjem korisniku ukoliko se promijeni status kartice.',
        'Object already linked as %s.' => 'Objekt je već povezan kao %s.',
        'Of couse this feature will take some system performance it self!' =>
            'Kada je ova funkcija aktivna, zauzeće deo sistemskih performansi.',
        'One or more errors occured!' => 'Dogodila se jedna ili više pogrešaka!',
        'Only for ArticleCreate Event.' => 'Samo za događaj kreiranja članka.',
        'Open Tickets' => 'Otvoreni kartice',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)' =>
            'Opcije za podatke aktuelnog korisnika (npr. <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>).' =>
            'Opcije podataka za aktuelnog korisnika (npr. <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Options of the current user who requested this action (e. g. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)' =>
            'Podešavanja za korisnika koji je zahtevao ovu akciju (npr. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)' =>
            'Informacije o aktuelnom korisniku koji je tražio ovu akciju (npr. <OTRS_CURRENT_UserFirstname>)',
        'Options of the ticket data (e. g. &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)' =>
            'Opcije pdataka o kartici (npr. &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)',
        'Options of the ticket data (e. g. <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' =>
            'Opcije podataka o kartici (npr. <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' =>
            'Opcije podataka o kartici (npr. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        ...
        'Package not correctly deployed! You should reinstall the Package again!' =>
            'Paket nije korektno instaliran! Trebalo bi ga ponovno instalirati!',
        'Package not correctly deployed! You should reinstall the package again!' =>
            'Paket nije ispravno instaliran. Trebalo bi ga instalirati ponovno!',
        'Param 1' => 'Param 1',
        'Param 2' => 'Param 2',
        'Param 3' => 'Param 3',
        'Param 4' => 'Param 4',
        ...
        'Password for SMTP Auth' => 'Lozinka za "SMTP" autentikaciju',
        'Password is already used! Please use an other password!' => 'Ova lozinka je već u upotrebi, molimo odaberite neku drugu!!',
        'Passwords doesn\'t match! Please try it again!' => 'Lozinke se ne poklapaju! Molimo pokušajte ponovo!',
        'Pending Times' => 'Vremena čekanja',
        'Pending messages' => 'Poruke na čekanju',
        'Pending type' => 'Tip čekanja',
        ...
        'SMTP Auth Password' => '"SMTP" Lozinka',
        'Save Job as?' => 'Sačuvaj posao kao?',
        'Save Search-Profile as Template?' => 'Sačuvaj profil pretrage kao šablon?',
        'Schedule' => 'Raspored',
        'Search Result' => 'Rezultat pretrage',
        'Search Ticket' => 'Pretraživanje kartice',
        'Search for' => 'Potraga za',
        'Search for customers (wildcards are allowed).' => 'Nađi korisnika (džoker znaci su dozvoljeni).',
        'Search-Profile as Template?' => 'Profil pretraživanja kao predložak?',
        ...
        'Select outbound mail type' => 'Izaberi tip odlazne pošte',
        'Select the customeruser:service relations.' => 'Izaberite Korisnik:servis veze.',
        'Select the element, which will be used at the X-axis' => 'Izaberi element koji će biti upotrebljen na X-osi.',
        'Select the restrictions to characterise the stat' => 'Izaberite ograničenja koja karakterišu statistiku',
        'Select the role:user relations.' => 'Izaberite ulogu:korisničke veze.',
        'Select the user:group permissions.' => 'Izaberite korisnika:grupne dozvole.',
        'Select your QueueView refresh time.' => 'Odaberite vrijeme osvježavanja pregleda repa.',
        'Select your default spelling dictionary.' => 'Odaberite zadani rečnik za proveru pravopisa.',
        'Select your frontend Charset.' => 'Izaberite karakterset vašeg interfejsa.',
        'Select your frontend QueueView.' => 'Izaberite pregled repa.',
        'Select your frontend language.' => 'Izaberite jezik sučelja.',
        'Select your out of office time.' => 'Odaberite vaše vanuredovno vrijeme.',
        ...
        'Send Administrative Message to Agents' => 'Pošalji administrativnu poruku zaposlenicima.',
        'Send Notification' => 'Pošalji obaveštenje',
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.' =>
            'Obavijesti me ukoliko korisnik pošalje nastavak, a ja sam vlasnik ove kartice.',
        'Sent new password to: ' => 'Pošalji novu lozinku za: ',
        'Sent new password to: %s' => 'Poslata nova lozinka za %s.',
        'Sent password reset instructions to %s. Please check your email.' =>
            'Uputa za reset lozinke poslana za %s. Molimo provjerite vašu E-poštu.',
        ...
        'Some result formats are disabled because at least one needed package is not installed. Please contact your administrator.' =>
            'Neki su formati rezultata onemogućeni jer neki od paketa nije instaliran. Molimo kontaktirajte vašeg administratora.',
        ...
        'Take care that you also updated the default states in you Kernel/Config.pm!' =>
            'Nemojte zaboraviti ažurirati i zadane statuse u "Kernel/Config.pm" datoteci!',
        'Text is required!' => 'Tekst je obavezan',
        'The Ticket was locked' => 'Kartica je zaključana',
        'The User Name you wish to have' => 'Korisničko ime koje bi ste željeli',
        ...
        'The message being composed has been closed.  Exiting.' => 'Poruka koja se piše je zatvorena.',
        'The subject is required!' => 'Predmet je obavezan!',
        'The subject is required.' => 'Predmet je obavezan.',
        'The text is required!' => 'Tekst je obavezan!',
        'The text is required.' => 'Tekst je obavezan.',
        'These values are read-only.' => 'Ove vrednosti su samo za čitanje.',
        'These values are required.' => 'Ove vrednosti su obavezne.',
        'This account exists.' => 'Ovaj nalog postoji.',
        'This email address already exists. Please log in or reset your password..' =>
            'Ova adresa E-pošte već postoji. Molimo, prijavite se ili resetujte vašu lozinku',
        'This is useful if you want that no one can get the result of the stat or the stat isn\'t ready configurated.' =>
            'Ovo je korisno ukoliko ne želite da iko vidi rezultate statistike ili konfiguracija statistike nije završena.',
        'Ticket Lock' => 'Zaključan karticu',
        ...
        'To get the article attribute (e. g. (<OTRS_AGENT_From>, <OTRS_AGENT_To>, <OTRS_AGENT_Cc>, <OTRS_AGENT_Subject> and <OTRS_AGENT_Body>).' =>
            'Da bi videli atribute članka (npr. (<OTRS_AGENT_From>, <OTRS_AGENT_To>, <OTRS_AGENT_Cc>, <OTRS_AGENT_Subject> und <OTRS_AGENT_Body>).',
        ...
        'To: (%s) replaced with database email!' => 'Za: (%s) zamijenjena adresa E-pošte onom iz baze!',
        'Top of Page' => 'Vrh strane',
        'Total hits' => 'Ukupno pogodaka',
        'U' => 'U',
        'Unable to parse Online Repository index document!' => 'Nije moguće raščlaniti indeks mrežnog skladišta!',
        'Unlock Tickets' => 'Otključaj karticu',
        'Unlock to give it back to the queue!' => 'Otključaj da bi je vratio u rep!',
        'Unsubscribe' => 'Otkaži pretplatu',
        'Use utf-8 it your database supports it!' => 'Koristite "utf-8" samo ako ga vaša baza podataka podržava!',
        'Useable options' => 'Upotrebljive opcije',
        'Used default language.' => 'Upotrebljeni zadani jezik.',
        'Used log backend.' => 'Upotrebljena metoda beleženja dnevnika.',
        'User Management' => 'Upravljanje korisnicima',
        'User for Inbound Mail' => 'Korisnik za prijem pošte',
        'User will be needed to handle tickets.' => 'Neophodan je zaposlenik za obradu kartice.',
        'User-Name' => 'Korisničko ime',
        'User-Number' => 'Korisnik broj',
        'Username for SMTP Auth' => 'Korisničko ime za "SMTP" autentikaciju',
        'Username{CustomerUser}' => 'Korisničko ime (korisnik)',
        'Users' => 'Korisnici',
        ...
        'Warning! This tickets will be removed from the database! This tickets are lost!' =>
            'Pažnja! Ovi kartice će biti uklonjeni iz baze i trajno izgubljeni!',
        'Watch notification' => 'Praćenje obaveštenja',
        'We stop eating if you wish us to do.' => 'Prestajemo i s našim objedom ukoliko to želite.',
        'Web-Installer' => 'Web-Instalacija',
        'Welcome to OTRS' => 'Dobrodošli u OTRS',
        'Wildcards are allowed.' => 'Džoker znakovi su dozvoljeni.',
        'With the input and select fields you can configurate the stat at your needs. Which elements of a stat you can edit depends on your stats administrator who configurated the stat.' =>
            'Unosom i izborom polja možete konfigurirati statistiku prema vašim potrebama. Koje elemente statistike možete mijenjati ovisi o konfiguraciji statistike.',
        'Workflow Groups' => 'Grupe pravilnika rada',
        'Yes, save it with name' => 'Da, sačuvaj sa imenom',
        'You as the customer have the ability to let us support staff people jump around as you wish because it\'s all about you. We stop eating if you wish us to do. Your way to communicate with us is this thing called \'ticket\'. Please command us.' =>
            'Bi kao korisnik imate privilegiju da budete u centru pažnje osoblja tehničke podrške. Učinićemo sve kako bi Vi bili zadovoljni. Način da efikasno komunicirate s nama je ova stvar koja se zove "kartica". Molimo vas, prenesite nam Vaš problem.',
        'You got new message!' => 'Primili ste novu poruku!',
        'You have not created a ticket yet.' => 'Još uvijek niste otvorili karticu.',
        'You need a to: recipient!.' => 'Primtelj, polje "Za:" je obavezno!',
        'You need to account time!' => 'Potrebno je da obračunti vrijeme!',
        'You need to activate %s first to use it!' => 'Morate aktivirati %s prije upotrebe!',
        'Your Password' => 'Vaša lozinka',
        'Your email address is new' => 'Vaša adresa E-pošte je nova',
        'Your email with ticket number "<OTRS_TICKET>" is bounced to "<OTRS_BOUNCE_TO>". Contact this address for further information.' =>
            'Vaša E-pošta sa karticom broj "<OTRS_TICKET>" je preusmjerena za "<OTRS_BOUNCE_TO>". Tamo ćete pronaći dodatne informacije.',
        'Your own Ticket' => 'Vaš karticu',
        'Your way to communicate with us is this thing called \'ticket\'.' =>
            'Vaš način komuniciranja s nama je ova stvar zvana "kartica".',
        ...
        'for agent user id' => 'za korisnički ID zaposlenog',
        'go back' => 'nazad',
        ...
        'read' => 'čitaj',
        'send' => 'Pošalji',
        'sort downward' => 'sortiraj padajuće',
        'sort upward' => 'sortiraj rastuće',
        'tmp_lock' => 'zaključavanje (privremeno)',
        ...
        'to get the realname of the sender (if given)' => 'vidjeti pravo ime pošiljaoca (ako je moguće)',
        'unknown' => 'nepoznato',
        'unread' => 'nepročitano',
        'up' => 'uključeno',
        'utf8' => '"utf8"',
