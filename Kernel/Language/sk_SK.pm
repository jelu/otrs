...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'This message was written in a character set other than your own.' =>
            'Táto správa bola napísaná v inej znakovej sade =>  ako je vaša.',
        ...
        'Send me a notification if a ticket is unlocked by the system.' =>
            'Pošli mi oznámenie =>  ak je požiadavka odblokovaná systémom.',
        ...
        '(The identify of the system. Each ticket number and each http session id starts with this number)' =>
            'Identifikácia systému. Každé číslo požiadavky a každá http začína týmto číslo.',
        '(Ticket identifier. Some people want to set this to e. g. \'Ticket#\',\'Call#\' or \'MyTicket#\')' =>
            '(Identifikátor požiadavky. Niektorí ľudia to chcú nastaviť napríklad: \'Ticket#\', \'Call#\' alebo \'MyTicket#\')',
        ...
        '0 = žiadne odomkýnanie' => 'Escalation time',
        '0 = žiadne zvyšovanie' => 'Follow up Option',
        ...
        'Admin-používateľ' => 'Admin-Password',
        'Adresa odosielateľa tohto radu pre e-mailovú odpoveď.' => 'The salutation for email answers.',
        'Adresáti' => 'Body',
        'Agent Preferences' => 'Nastavenia úžívateľa',
        'Ak je požiadavka zatvorená a klient pošle nasledujúcu požiadavku =>  požiadavka bude zamknutá pre starého majiteľa.' =>
            'Will be the sender address of this queue for email answers.',
        'Ak je váš účet ' => 'PostMaster Filter Management',
        'Ak nebude na požiadavku odpovedané do určitého času =>  bude táto požiadavka zobrazená!' =>
            'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.',
        'Ak používate RegExp =>  môžete tiež používať prepojené hodnoty v () ako [***] v \'Set\'.' =>
            'Queue <-> Auto Responses Management',
        'Ak zástupca uzamkne požiadavku a on/ona nepošle odpoveď do určitého času =>  bude požiadavka automaticky odomknutá a tak zobraziteľná pre všetkých zástupcov.' =>
            'If a ticket will not be answered in this time =>  just only this ticket will be shown.',
        'Aktuálny stav požiadavky je' => 'Your email address is new',
        ...
        'Can\'t update password =>  need 2 lower and 2 upper characters!' =>
            'Nemožno aktualizovať heslo =>  potrebujete 2 malé a 2 veľké písmená',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' =>
            'Nepracujte s používateľským číslom 1 (systémový účet)! Vytvorte nového používateľa.',
        'Drop Database' => 'vymazať databázu',
        'Dávajte pozor =>  či je aktualizovaný tiež ' => 'See also',
        'Dôveryhodný' => 'Dispatching',
        'FileManager' => 'Správca súborov',
        'Filtername' => 'Match',
        'Follow up' => 'nasledujúci',
        'Follow up notification' => 'Nasleduj hlásenie.',
        'Fulltextové vyhľadávanie v článku (napr. Mar*in" alebo "Baue*")"' =>
            '(e. g. 10*5155 or 105658*)',
        ...
        'If nothing is selected =>  then there are no permissions in this group (tickets will not be available for the user).' =>
            'Ak nie je nič vybrané =>  nie je dovolené pracovať v tejto skupine (požiadavky nie sú dostupné pre užívateľa)',
        'Important' => 'Dôležité',
        'In this way you can directly edit the keyring configured in Kernel/Config.pm.' =>
            'Týmto spôsobom môžete priamo upravovať kľúčové nastavenie v Kenel/Config.',
        'Incident' => 'Udalosť',
        'Ine' => 'Notification Management',
        'It\'s useful for ASP solutions.' => 'System Log',
        'Je práca platná' => 'Schedule',
        'Je práca platná?' => 'Is Job Valid',
        'Je to použiteľné pre množstvo užívateľov a skupín.' => 'Roles <-> Groups Management',
        'Kontrola pravopisu' => 'spelling error(s)',
        'Kľúčové slová' => 'Symptom',
        ...
        'Login failed! Your username or password was entered incorrectly.' =>
            'Prihlásenie zlyhalo! Vaše používateľské meno alebo heslo bolo vložené nesprávne.',
        ...
        'Možnosti aktuálneho používateľa =>  ktorý požaduje tieto akcie (napr. <OTRS_CURRENT_UserFirstname>)' =>
            'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Možnosti majiteľa požiadavky (napr. <OTRS_OWNER_UserFirstname>)' =>
            'Options of the current user who requested this action (e. g. <OTRS_OWNER_UserFirstname>)',
        'Možnosti údajov aktuálnohe klientského užívateľa (napr. <OTRS_CUSTOMER_DATA_UserFirstname>)' =>
            'Package Manager',
        'Musíte napísať emailovú adresu (napr. klient@príklad.com) do Príjemca:!' =>
            'Bounce ticket',
        'Musíte používať číslo požiadavky!' => 'Ticket Merge',
        'My Queue' => 'Môj rad',
        'MyTickets' => 'Moje požiadavky',
        'Naozaj chcete zmazať tento objekt?' => 'System History',
        'Nastaviť' => 'Do dispatch or filter incoming emails based on email X-Headers! RegExp is also possible.',
        ...
        'Nezabudnite pridať novú odpoveď radu!' => 'Next state',
        'No Permission' => 'Nepovolené',
        ...
        'OTRS posiela klientom oznámenie e-mailom =>  ak bola požiadavka premiestnená.' =>
            'OTRS sends an notification email to the customer if the ticket state has changed.',
        'OTRS posiela klientom oznámenie e-mailom =>  ak sa zmenil majiteľ požiadavky.' =>
            'Responses <-> Queue Management',
        'OTRS posiela klientom oznámenie e-mailom =>  ak sa zmenil stav požiadavky.' =>
            'OTRS sends an notification email to the customer if the ticket owner has changed.',
        'Options of the ticket data (e. g. <OTRS_TICKET_Number> =>  <OTRS_TICKET_ID> =>  <OTRS_TICKET_Queue> =>  <OTRS_TICKET_State>)' =>
            'Možnosti údajov požiadavky (napr. <OTRS_TICKET_Number> =>  <OTRS_TICKET_ID> =>  <OTRS_TICKET_Queue> =>  <OTRS_TICKET_State>)',
        'Other Options' => 'Ostatné Možnosti',
        'Otvorené požiadavky' => 'Split',
        'PGP manažment' => 'Identifier',
        'POP3 Account Management' => 'Host',
        'Package not correctly deployed =>  you need to deploy it again!' =>
            'Balík nie je správne rozmiestnený =>  musíte ho rozmiestniť ešte raz.',
        ...
        'Platnosť' => 'In this way you can directly edit the keyring configured in SysConfig.',
        'Please contact your admin' => 'Prosím kontaktujte vášho administrátora.',
        'Podpis pre e-mailovú odpoveď.' => 'OTRS sends an notification email to the customer if the ticket is moved.',
        'Podrad (čoho)' => 'Unlock timeout',
        'Poslať' => 'GenericAgent',
        'Potrebujete minimálne 1 vybranú požiadavku!' => 'Spell Checker',
        'Potrebujete časové konto!' => 'Close ticket',
        'Použiť tieto zmeny.' => 'A message should have a To: recipient!',
        'Povolenie presunúť požiadavky do tejto skupiny/radu.' => 'create',
        'Povolenie vytvoriť požiadavku v tejto skupine/rade.' => 'owner',
        'Povolenie zmeniť majiteľa požiadavky v tejto skupine/rade.' =>
            'priority',
        'Povolenie zmeniť prioritu požiadavky v tejto skupine/rade.' =>
            'Role',
        'Pozdrav pre e-mailovú odpoveď.' => 'The signature for email answers.',
        'Pozor! Táto požiadavka bude vymazaná z databázy. Tieto požiadavky sú stratené!' =>
            'Modules',
        'Pošli mail!' => 'A message should have a subject!',
        'Požadovať nové heslo' => 'Create Account',
        'Požiadavky vybrané pre hromadnú akciu!' => 'You need min. one selected Ticket!',
        'Pre hlásenie chyby =>  kliknite tu!' => 'Comment (internal)',
        'Prehľad hovorov' => 'Top of Page',
        'Prehľad radu.' => 'PhoneView',
        'Prestavať' => 'Reinstall',
        'Priezvisko' => 'User will be needed to handle tickets.',
        'Print this ticket!' => 'Vytlač túto požiadavku.',
        'Problem' => 'Solution',
        'Prístupový kľúč' => 'System Email Addresses Management',
        ...
        'Reakcia je prednastavený text pre rýchlejšie písanie odpovedí klientom.' =>
            'Don\'t forget to add a new response a queue!',
        'Reakcie <-> Prílohy manažmentu' => 'Response Management',
        'Reakcie <-> Rady manažmentu' => 'Answer',
        'Reinštalovať' => 'PGP Management',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.' =>
            'Pošli mi oznámenie =>  ak klient pošle overenie a ja som vlastník tejto požiadavky.',
        'Send me a notification if a ticket is moved into one of My Queues"."' =>
            'Pošli mi oznámenie =>  ak je požiadavka premiestnená do jedného z mojich radov.',
        'Send me a notification if there is a new ticket in My Queues"."' =>
            'Pošli mi notifikáciu =>  ak je nová požiadavka v MyQueue ?',
        ...
        'Skupiny' => 'Misc',
        'Skutočne chcete odinštalovať tento balík?' => 'Install',
        'Skutočné meno' => 'All incoming emails with this Email" (To:) will be dispatched in the selected queue!"',
        'Source' => 'zdroj',
        'Spojiť' => 'Header',
        'Správa by mala mať predmet!' => 'Ticket Bulk Action',
        'Správa hlásení' => 'Notification',
        'Správa musí mať príjemcu!' => 'You need a email address (e. g. customer@example.com) in To:!',
        'Správa musí mať telo.' => 'You need to account time!',
        'Správa skupín' => 'The admin group is to get in the admin area and the stats group to get stats area.',
        'Správa užívateľov' => 'Firstname',
        'Spusti!' => 'x',
        'Stats-Area' => 'štatistická oblasť',
        'Stav ´dalšej požiadavky' => 'Inform sender',
        'Stiahnuť' => 'Rebuild',
        'Stiahnuť nastavenia.' => 'Download all system config changes.',
        'Stiahnuť všetky zmeny systémovej konfigurácie.' => 'Load Settings',
        'Symptóm' => 'Problem',
        'Telo správy' => 'send',
        'Termin1' => 'Termín1',
        'Text bez požiadavky' => 'Ticket Lock',
        'Text poznámky' => 'Close type',
        'The message being composed has been closed.  Exiting.' => 'Vytvorená správa bola zatvorená. ',
        'These values are read-only.' => 'Táto hodnota je iba na čítanie',
        'These values are required.' => 'Táto hodnota je požadovaná.',
        ...
        'Týmto spôsobom môžete priamo upravovať konfigurácie' => 'POP3 Account Management',
        'U' => 'sort downward',
        'Uložiť' => 'Group Management',
        'Uložiť prácu ako?' => 'Is Job Valid?',
        'Uložiť vyhľadávací profil ako šablónu?' => 'Yes =>  save it with name',
        'Uniq' => 'kill all sessions',
        'Unlock požiadavky.' => 'A message should have a body!',
        ...
        'Užívatelia' => 'Groups',
        'V správe musí byť skontrolovaný pravopis.' => 'Compose answer for ticket',
        'Vaša e-mailová adresa je nová.' => 'Role Management',
        'Vaša vlastná požiadavka' => 'Compose Follow up',
        'Vaše MySQL DB' => 'Database-User',
        'Verzia' => 'Vendor',
        'Vitajte v %' => 'of',
        'Vybaviť =>  alebo filtrovať prichádzujúce e-maly =>  na báze e-mailu X-header! Reg-Exp je tiež možný!' =>
            'If you use RegExp =>  you also can use the matched value in () as [***] in \'Set\'.',
        'Vyhľadávacia šablóna' => 'Created in Queue',
        'Vykonanie' => 'All incoming emails with one account will be dispatched in the selected queue!',
        'Vytvoriť funkciu a dať ju do skupiny. Potom pridať funkciu užívateľom.' =>
            'It\'s useful for a lot of users and groups.',
        'Vytvoriť odpoveď na požiadavku.' => 'Attach',
        'Vytvoriť v rade.' => 'Output',
        'Vytvoriť účet' => 'Welcome %s',
        'Váš e-mail s číslom požiadavky <OTRS_POŽIADAVKA> je pripojený k <OTRS_PRIPOJIŤ_K_POŽIADAVKE>' =>
            'Queue ID',
        'Výsledok z' => 'Save Search-Profile as Template?',
        'Všetky požiadavky' => 'Queues',
        'Všetky prichádzajúce e-maily s jedným účtom budú vybavené vo vybranom rade.' =>
            'If your account is trusted =>  the already existing x-otrs header at arrival time (for priority =>  ...) will be used! PostMaster filter will be used anyway.',
        'Všetky prichádzajúce e-maily s príjemcom =>  budú vybavené v radoch.' =>
            'User Management',
        ...
        'Zamknúť' => 'Traceback',
        'Zatvoriť požiadavku' => 'Note Text',
        'Začiatok strany' => 'Home',
        'Zmazané požiadavky' => 'Warning! This tickets will be removed from the database! This tickets are lost!',
        'Zmenený' => 'Last update',
        'Zmeň prioritu požiadavky.' => 'Tickets shown',
        'Zástupca' => 'TicketFreeText',
        'akceptovať licenciu' => 'don\'t accept license',
        ...
        'dostupné požiadavky' => 'All tickets',
        'funkcia <-> riadenie užívateľov' => 'Active',
        'generovaný zástupca' => 'Job-List',
        'história klientského hľadania' => 'Customer history search (e. g. ID342425")."',
        'história klientského hľadania (napr. ID342425")' => 'No * possible!',
        'hlásenie klientovho pohybu' => 'Customer State Notify',
        'hlásenie majiteľa klienta' => 'If an agent locks a ticket and he/she will not send an answer within this time =>  the ticket will be unlock automatically. So the ticket is viewable for all other agents.',
        'hlásenie stavu klienta' => 'Customer Owner Notify',
        'hore' => 'down',
        'hromadná akcia požiadaviek' => 'Spell Check',
        'identifikátor' => 'Bit',
        'info' => 'Link Object',
        'informovať odosielateľa.' => 'Your email with ticket number <OTRS_TICKET>" is bounced to "<OTRS_BOUNCE_TO>". Contact this address for further information."',
        'inštalovať' => 'Package',
        'klientský užívateľ' => 'Add Note',
        'komentár (vnútorný)' => 'A article should have a title!',
        'kontaktovať klienta' => 'Change queue',
        'kontrola pravopisu' => 'Note type',
        'kým' => 'Change priority of ticket',
        'kľúč' => 'Fingerprint',
        'limit' => 'Select Box Result',
        'login klientského užívateľa' => '(e. g. U5150)',
        'majiteľ' => 'Permissions to change the ticket owner in this group/queue.',
        'materský objekt' => 'Child-Object',
        'miestna schránka' => 'Status',
        'možnosti' => 'Inform involved Agents',
        'možnosti configurácie' => 'Default',
        'možnosti konfigurácie (napr. <OTRS_CONFIG_HttpType>)' => 'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>)',
        'nasledujúce možnosti' => 'Ticket lock after a follow up',
        'načítať nastavenia' => 'Subgroup',
        'neakceptovať licenciu' => 'Admin-User',
        ...
        'obsah' => 'New',
        'odinštalovať' => 'Verion',
        'odpoveď' => 'Responses <-> Attachments Management',
        'odpoveď riadenia' => 'A response is default text to write faster answer (with default text) to customers.',
        'parameter 1' => 'Param 2',
        'parameter 2' => 'Param 3',
        'parameter 3' => 'Param 4',
        'parameter 4' => 'Param 5',
        ...
        'používateľ databázy' => 'default \'hot\'',
        'pozri aj' => 'SysConfig',
        'počet úderov' => 'Site',
        'požiadavky' => 'All messages',
        'pre agentovo používateľské id' => 'for agent login',
        'pre login agenta' => 'Select Box',
        'pre meno agenta' => 'for agent lastname',
        'pre priezvisko agenta' => 'for agent user id',
        'predchádzajúci' => 'Block',
        'predchádzajúci majiteľ' => 'Add note to ticket',
        'prednastavený' => 'Prio',
        'predvolený (?)' => 'DB connect host',
        'premiestniť_do' => 'Permissions to move tickets into this group/queue.',
        'prepojený objekt' => 'Parent-Object',
        'preskočiť na' => 'Next ticket state',
        'preskočiť požiadavku' => 'Bounce to',
        'presuň požiadavku' => 'Previous Owner',
        'priadať poznámku' => 'CMD',
        'pridaj osobný kľúč' => 'Secret',
        'pridať poznámku k požiadavke' => 'Inform Agent',
        'priložiť' => 'Pending Date',
        'priorita' => 'Permissions to change the ticket priority in this group/queue.',
        'pripojená požiadavka' => 'Merge to',
        'pripojiť k' => 'Your email with ticket number <OTRS_TICKET>" is merged to "<OTRS_MERGE_TO_TICKET>"."',
        'pripomienkovač' => 'Sort by',
        ...
        'skutočné meno klienta' => 'for agent firstname',
        'správa systémovej e-mailovej adresy' => 'Email',
        'stav' => 'Overview',
        'strana' => 'Tickets available',
        'stupňovanie požiadaviek' => 'Your own Ticket',
        ...
        'ukázať' => 'Download Settings',
        'uzamknúť požiadavku po nasledovnom' => 'Systemaddress',
        'vsetky zakaznikove premenne ako tie definovane v konfiguracnej moznosti (volbe) CustomerUser' =>
            'The current ticket state is',
        'vyber funkciu: prepojenia užívateľov' => 'Salutation Management',
        'vyber priečinok' => 'SQL',
        'vyhľadať' => 'Ticket selected for bulk action!',
        'vyhľadávanie požiadavky' => 'Profile',
        'vytvorit nove skupiny pre osetrenie pristupovych prav roznych skupin agentov (napr. Oddelenie nákupu =>  oddelenie predaja => ..)' =>
            'It\'s useful for ASP solutions.',
        'vytvoriť' => 'Permissions to create tickets in this group/queue.',
        'vytvoriť nasledujúcu' => 'Compose Answer',
        'vytvoriť odpoveď' => 'Contact customer',
        'výber' => 'Results',
        'výber skupiny' => 'Show',
        'výsledky' => 'Total hits',
        'výsledok hľadania ' => 'Change search options',
        'všetky správy' => 'New messages',
        'x' => 'Save Job as?',
        'z' => 'Click here to report a bug!',
        'zmeniť rady' => 'Ticket Search',
        'zmeň možnosti hľadania' => '"}',
        'zobrazenie stavu požiadavky' => 'Open Tickets',
        'zobrazené požiadavky' => 'Page',
        'zoznam úloh' => 'Last run',
        'zruš všetky relácie' => 'Session',
        'zrušiť relácie' => 'Signature Management',
        'zvyšovať v' => 'Linked-Object',
        'Áno =>  ulož s menom.' => 'Customer history search',
        'úloha' => 'Roles <-> Users Management',
        'úlohy  <-> riadenie skupín' => 'move_into',
        'Časová jednotka' => ' (work units)',
        'čas' => 'Users',
        'čas eskalácie' => '0 = no escalation',
        'čas vybavenia' => 'for pending* states',
        'časti' => 'Config Options',
        'Ďalší ' => 'All Customer variables like defined in config option CustomerUser.',
        'žiadna * nie je možná' => 'Search Result',
