...
（例：From / \'(.+?)@.+?\'とし、「Set」にて「[***]」として後方参照を使用します。）',
        ...
        '(The identify of the system. Each ticket number and each http session id starts with this number)' =>
            '(システム識別子。各チケット番号はHTTPセッションidとこの番号で開始されます。)',
        '(Ticket identifier. Some people want toset this to e. g. \'Ticket#\', \'Call#\' or \'MyTicket#\')' =>
            '(チケット識別子。一部の人はこれを設定します。例: \'Ticket#\'、\'Call#\'、\'MyTicket#\')',
        ...
        'A filter for HTML output to add links behind a defined string. The element Image allows two input kinds. First the name of an image (e.g. faq.png). In this case the OTRS image path will be used. The second possibility is to insert the link to the image.' =>
            '定義された文字列の後ろにリンクを追加するための、HTMLアウトプットに関するフィルターです。要素イメージは、2つの種類のインプットを許可します。1つ目は、イメージの名前です（faq.pngなど）。この場合では、OTRSイメージのパスが使用されます。2つめの可能性は、イメージへのリンクの挿入です。',
        ...
        'Activates TypeAhead for the autocomplete feature, that enables users to type in whatever speed they desire, without losing any information. Often this means that keystrokes entered will not be displayed on the screen immediately.' =>
            'オートコンプリート機能のためのTypeAheadを有効にすることで、ユーザが希望するどのようなスピードにおいても情報を失うことなくタイプすることを可能にします。これにより、打鍵されたキーが即座に画面に表れない場合も起こり得ます。',
        'Add Change' => '変更管理の新規',
        'Add Customer User' => '顧客ユーザー追加',
        'Add Mapping Element' => 'マッピング要素を追加する',
        'Add Notification Rule' => '通知ルールを追加',
        'Add System Address' => 'システムアドレス追加',
        'Add User' => 'ユーザー追加',
        ...
        'Adds the one time vacation days for the calendar number 2. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー2の一度だけの休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the one time vacation days for the calendar number 3. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー3の一度だけの休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the one time vacation days for the calendar number 4. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー4の一度だけの休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the one time vacation days for the calendar number 5. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー5の一度だけの休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the one time vacation days for the calendar number 6. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー6の一度だけの休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the one time vacation days for the calendar number 7. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー7の一度だけの休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the one time vacation days for the calendar number 8. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー8の一度だけの休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the one time vacation days for the calendar number 9. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー9の一度だけの休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the permanent vacation days for the calendar number 1. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー1の定常的な休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the permanent vacation days for the calendar number 2. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー2の定常的な休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the permanent vacation days for the calendar number 3. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー3の定常的な休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the permanent vacation days for the calendar number 4. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー4の定常的な休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the permanent vacation days for the calendar number 5. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー5の定常的な休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the permanent vacation days for the calendar number 6. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー6の定常的な休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the permanent vacation days for the calendar number 7. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー7の定常的な休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the permanent vacation days for the calendar number 8. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー8の定常的な休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Adds the permanent vacation days for the calendar number 9. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' =>
            'カレンダー・ナンバー9の定常的な休日を追加します。数字は1～9までのシングル・デジットを使用してください（01～09ではない）。',
        'Admin State Machine' => '機器状態の管理',
        'Admin Support Info' => '管理サポート情報',
        'Admin of notification rules.' => '通知ルールの管理',
        'Admin of the CIP matrix.' => 'CIP配列の管理',
        'Admin of the state machine.' => '機器状態の管理',
        'Admin-Area' => '管理領域',
        'Admin-Password' => '管理者パスワード',
        'Admin-Support Overview' => '管理サポート概要',
        'Admin-User' => '管理者',
        'Admin-password' => '管理者パスワード',
        ...
        'All Customer variables like defined in config option CustomerUser.' =>
            '全ての顧客の変数が設定オプションCustomerUserで定義されます。',
        'All customer tickets.' => '全ての顧客チケット',
        'All email addresses get excluded on replaying on composing an email.' =>
            '全てのメールアドレスがメール返信を作成するときに除外されます',
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' =>
            'この電子メール (To:) と全ての受信メールが、選択したキューに振り分けられます！',
        ...
        'Article free text options shown in the additional ITSM field screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースにおける追加ITSMフィールド画面で表示される、項目フリー・テキスト・オプションです。可能性ある設定：0 = 無効, 1 = 有効, 2 = 有効かつ必要。',
        'Article free text options shown in the close ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのクローズ・チケット画面で、表示される項目フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Article free text options shown in the decision screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースにおける決定画面で表示される、項目フリー・テキスト・オプションです。可能性ある設定：0 = 無効, 1 = 有効, 2 = 有効かつ必要。',
        'Article free text options shown in the email ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのEメール・チケット画面で、表示される項目フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Article free text options shown in the phone ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースの電話チケット画面で、項目フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Article free text options shown in the ticket compose screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット構成画面で、表示される項目フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Article free text options shown in the ticket free text screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット・フリー・テキスト・スクリーンで、表示される項目フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Article free text options shown in the ticket message screen of the customer interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required. NOTE. If you want to display these fields also in the ticket zoom of the customer interface, you have to enable them in CustomerTicketZoom###AttributesView.' =>
            '顧客インタフェースのチケット・メッセージ画面で表示される、項目フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。注意：もしこれらのフィールドを顧客インタフェースのチケット・ズームにおいても表示させたい場合、CustomerTicketZoom###AttributesViewで有効にする必要があります。',
        'Article free text options shown in the ticket note screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット・ノート画面で、項目フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Article free text options shown in the ticket owner screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのズームされたチケットのチケット所有者画面で、表示される項目のフリー・テキスト・のオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Article free text options shown in the ticket pending screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのズームされたチケットのチケット保留画面で、表示される項目のフリー・テキスト・のオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Article free text options shown in the ticket phone outbound screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースからチケット・フォン・アウトバウンド画面で、表示されるフリー・テキストのオプションの項目です。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。）',
        'Article free text options shown in the ticket priority screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのズームされたチケットのチケット優先度画面で、表示される項目のフリー・テキスト・のオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Article free text options shown in the ticket responsible screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット責任者画面で、表示される項目のフリー・テキスト・のオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Attach' => '添付ファイル',
        'Attribute' => '属性',
        ...
        'Basic mail interface to System Monitoring Suites. Use this block if the filter should run AFTER PostMasterFilter.' =>
            'システム監視用の基本的なメールのインターフェースです。フィルタをPostMasterFilter後に実行する必要がある場合は、このブロックを使用してください。',
        'Basic mail interface to System Monitoring Suites. Use this block if the filter should run BEFORE PostMasterFilter.' =>
            'システム監視用の基本的なメールのインターフェースです。フィルタをPostMasterFilter前に実行する必要がある場合は、このブロックを使用してください。',
        ...
        'CONFIGITEM#' => '構成アイテム番号',
        'CSV' => 'CSV',
        'CURRENT INCIDENT STATE' => '現在のインシデント状態',
        'Can not create link with %s!' => '%sと連結できませんでした！',
        'Can not delete link with %s!' => '%sと連結が解除できませんでした！',
        'Can\'t connect to: http://otrs.org/product.xml' => 'http://otrs.org/product.xmlに接続できません。',
        ...
        'Can\'t update password, must contain 2 lower and 2 upper characters!' =>
            'パスワード更新ができません！ 英語大文字小文字が2文字以上必要です。',
        ...
        'Config options (e. g. <OTRS_CONFIG_HttpType>)' => '設定オプション (例 <OTRS_CONFIG_HttpType>)',
        'Config options (e. g. <OTRS_CONFIG_HttpType>).' => '設定オプション (例 <OTRS_CONFIG_HttpType).',
        'Configuration Item Limit' => '構成アイテム表示数',
        'Configuration Item limit per page' => '構成アイテムの1ページ毎の表示数',
        'Configures a default TicketFreeField setting. "Counter" defines the free text field which should be used, "Key" is the TicketFreeKey, "Value" is the TicketFreeText and "Event" defines the trigger event.' =>
            'デフォルトのTicketFreeFieldセッティングを、設定します。"Counter"は使用されるべきフリー・テキスト・フィールドを定義し、"Key"はTicketFreeKeyであり、"Value"はTicketFreeTextであり、"Event"はトリガー・イベントを定義します。',
        'Configures a default TicketFreeField setting. "Counter" defines the free text field which should be used, "Key" is the TicketFreeKey, "Value" is the TicketFreeText and "Event" defines the trigger event. Please check the developer manual (http://doc.otrs.org/), chapter "Ticket Event Module".' =>
            'デフォルトのTicketFreeFieldセッティングを、設定します。"Counter"は使用されるべきフリー・テキスト・フィールドを定義し、"Key"はTicketFreeKeyであり、"Value"はTicketFreeTextであり、"Event"はトリガー・イベントを定義します。開発者マニュアル(http://doc.otrs.org/)の"Ticket Event Module"の章を参照ください。',
        ...
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).' =>
            '新規グループ作成は担当者ごとのアクセス許可を処理します (例 購買部、サポート部、営業部、その他)。',
        'Create your first Ticket' => '最初のチケットを作成します。',
        'Create/Expires' => '作成／期限',
        'CreateTicket' => 'チケット作成',
        'Criticality' => '重要度',
        'Criticality <-> Impact <-> Priority' => '危険度 <-> 影響度 <-> 優先度',
        'CriticalityID' => '重要度ID',
        ...
        'Customer item (icon) which shows the open tickets of this customer as info block.' =>
            'その顧客のオープンのチケットをinfo blockとして表示するための、顧客アイテム（アイコン）です。',
        'Customer user will be needed to have a customer history and to login via customer panel.' =>
            '顧客ユーザーは顧客履歴と顧客パネルからログインするために必要です。',
        'CustomerID{CustomerUser}' => 'Customer ID',
        'CustomerUser' => '顧客ユーザー',
        'DB Admin Password' => 'DB 管理者パスワード',
        'DB Admin User' => 'DB 管理者ユーザー',
        'DB connect host' => 'DB接続先ホスト',
        'DEPLOYMENT STATE' => 'ディプロイ状態',
        'Decision' => '決定',
        'Decision Date' => '決定日',
        'Decision Result' => '判断結果',
        'Default' => '既定',
        'Default Charset' => '既定の文字コード',
        'Default Language' => '既定の言語',
        'Define Nagios acknowledge type.' => 'Nagiosが認識するタイプを定義してください。',
        'Define free text field for master ticket feature.' => '日付ピッカーにおける週の開始曜日を設定します。',
        'Define the FreeTextField 12 for tickets. With this setting you can define a new ticket attribute.' =>
            'チケットについて、新しいチケット属性を追加するため、free text field number 12を定義します。',
        'Define the free key field 12 for tickets. With this setting you can define a new ticket attribute.' =>
            'チケットについて、新しいチケット属性を追加するため、free key field number 12を定義します。',
        'Defines an external link to the database of the customer (e.g. \'http://yourhost/customer.php?CID=\' or \'\').' =>
            '顧客のデータベースに対する外部リンクを定義します（例：\'http://yourhost/customer.php?CID=$Data{"CustomerID"}\' or \'\'）。',
        ...
        'Defines the default body of a note in the decision screen of the agent interface.' =>
            '担当者インタフェースにおける決定画面で、注釈のデフォルトの本文を定義します。',
        ...
        'Defines the list of online repositories. Another installations can be used as repositoriy, for example: Key="http://example.com/otrs/public.pl?Action=PublicRepository;File=" and Content="Some Name".' =>
            'オンライン・レポジトリのリストの定義です。別にインストールされたものをレポジトリとして使用することができ、例えばKey=http://example.com/otrs/public.pl?Action=PublicRepository;File=および Content="Some Name"です。',
        'Defines the name of the calendar number 1.' => 'カレンダー・ナンバー1の名前を定義します。',
        'Defines the name of the calendar number 2.' => 'カレンダー・ナンバー2の名前を定義します。',
        'Defines the name of the calendar number 3.' => 'カレンダー・ナンバー3の名前を定義します。',
        'Defines the name of the calendar number 4.' => 'カレンダー・ナンバー4の名前を定義します。',
        'Defines the name of the calendar number 5.' => 'カレンダー・ナンバー5の名前を定義します。',
        'Defines the name of the calendar number 6.' => 'カレンダー・ナンバー6の名前を定義します。',
        'Defines the name of the calendar number 7.' => 'カレンダー・ナンバー7の名前を定義します。',
        'Defines the name of the calendar number 8.' => 'カレンダー・ナンバー8の名前を定義します。',
        'Defines the name of the calendar number 9.' => 'カレンダー・ナンバー9の名前を定義します。',
        'Defines the next state of a ticket after adding a note, in the additional ITSM field screen of the agent interface.' =>
            '担当者インタフェースにおける追加ITSMフィールド画面で、注釈を追加した後の、チケットの次の状態を定義します。',
        'Defines the next state of a ticket after adding a note, in the decision screen of the agent interface.' =>
            '担当者インタフェースにおける決定画面で、注釈を追加した後の、チケットの次の状態を定義します。',
        'Defines the the free key field number 13 for tickets to add a new ticket attribute.' =>
            'チケットについて、新しいチケット属性を追加するため、free key field number 13を定義します。',
        'Defines the the free key field number 14 for tickets to add a new ticket attribute.' =>
            'チケットについて、新しいチケット属性を追加するため、free key field number 14を定義します。',
        'Defines the the free key field number 15 for tickets to add a new ticket attribute.' =>
            'チケットについて、新しいチケット属性を追加するため、free key field number 15を定義します。',
        'Defines the the free key field number 16 for tickets to add a new ticket attribute.' =>
            'チケットについて、新しいチケット属性を追加するため、free key field number 16を定義します。',
        'Defines the time zone of the calendar number 1, which can be assigned later to a specific queue.' =>
            'カレンダー・ナンバー1のタイム・ゾーンを定義するものですが、後から特定のキューに割り当てることも可能です。',
        'Defines the time zone of the calendar number 2, which can be assigned later to a specific queue.' =>
            'カレンダー・ナンバー2のタイム・ゾーンを定義するものですが、後から特定のキューに割り当てることも可能です。',
        'Defines the time zone of the calendar number 3, which can be assigned later to a specific queue.' =>
            'カレンダー・ナンバー3のタイム・ゾーンを定義するものですが、後から特定のキューに割り当てることも可能です。',
        'Defines the time zone of the calendar number 4, which can be assigned later to a specific queue.' =>
            'カレンダー・ナンバー4のタイム・ゾーンを定義するものですが、後から特定のキューに割り当てることも可能です。',
        'Defines the time zone of the calendar number 5, which can be assigned later to a specific queue.' =>
            'カレンダー・ナンバー5のタイム・ゾーンを定義するものですが、後から特定のキューに割り当てることも可能です。',
        'Defines the time zone of the calendar number 6, which can be assigned later to a specific queue.' =>
            'カレンダー・ナンバー6のタイム・ゾーンを定義するものですが、後から特定のキューに割り当てることも可能です。',
        'Defines the time zone of the calendar number 7, which can be assigned later to a specific queue.' =>
            'カレンダー・ナンバー7のタイム・ゾーンを定義するものですが、後から特定のキューに割り当てることも可能です。',
        'Defines the time zone of the calendar number 8, which can be assigned later to a specific queue.' =>
            'カレンダー・ナンバー8のタイム・ゾーンを定義するものですが、後から特定のキューに割り当てることも可能です。',
        'Defines the time zone of the calendar number 9, which can be assigned later to a specific queue.' =>
            'カレンダー・ナンバー9のタイム・ゾーンを定義するものですが、後から特定のキューに割り当てることも可能です。',
        'Defines the years (in future and in past) which can get selected in free time field number 1.' =>
            'free time field number 1において選択され得る年（未来または過去）を定義します。',
        'Defines the years (in future and in past) which can get selected in free time field number 2.' =>
            'free time field number 2において選択され得る年（未来または過去）を定義します。',
        'Defines the years (in future and in past) which can get selected in free time field number 3.' =>
            'free time field number 3において選択され得る年（未来または過去）を定義します。',
        'Defines the years (in future and in past) which can get selected in free time field number 4.' =>
            'free time field number 4において選択され得る年（未来または過去）を定義します。',
        'Defines the years (in future and in past) which can get selected in free time field number 5.' =>
            'free time field number 5において選択され得る年（未来または過去）を定義します。',
        'Defines the years (in future and in past) which can get selected in free time field number 6.' =>
            'free time field number 6において選択され得る年（未来または過去）を定義します。',
        'Defines whether the free time field number 1 is optional or not.' =>
            'free time field number 1がオプションであるかどうかを定義します。',
        'Defines whether the free time field number 2 is optional or not.' =>
            'free time field number 2がオプションであるかどうかを定義します。',
        'Defines whether the free time field number 3 is optional or not.' =>
            'free time field number 3がオプションであるかどうかを定義します。',
        'Defines whether the free time field number 4 is optional or not.' =>
            'free time field number 4がオプションであるかどうかを定義します。',
        'Defines whether the free time field number 5 is optional or not.' =>
            'free time field number 5がオプションであるかどうかを定義します。',
        'Defines whether the free time field number 6 is optional or not.' =>
            'free time field number 6がオプションであるかどうかを定義します。',
        'Definition of the Cron checks.' => 'Cronのチェック項目の定義',
        'Definition of the OTRS checks.' => 'OTRSのチェック項目の定義',
        'Definition of the Operating System checks.' => 'OSのチェック項目の定義',
        'Definition of the database checks for the DB2 database.' => 'DB2データベースのチェック項目の定義',
        'Definition of the database checks for the MSSQL database.' => 'MSSQLデータベースのチェック項目の定義',
        'Definition of the database checks for the MySQL database.' => 'MySQLデータベースのチェック項目の定義',
        'Definition of the database checks for the Oracle database.' => 'Oracleデータベースのチェック項目の定義',
        'Definition of the database checks for the PostgreSQL database.' =>
            'PostgreSQLデータベースのチェック項目の定義',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' =>
            'ユーザーID 1 (システムアカウント) では作業しないでください。新規ユーザーを作成してください！',
        ...
        'E-Mail' => 'メール',
        'Edit Customers' => '顧客編集',
        'Edit common information' => '共通情報を編集する',
        'Edit default services.' => '既定のサービスの編集',
        'Edit format information' => 'フォーマット情報を編集する',
        'Edit mapping information' => 'マッピング情報を編集する',
        'Edit object information' => 'オブジェクト情報を編集する',
        'Edit search information' => '検索情報を編集する',
        'Email based' => 'メール経由',
        'Email of the system admin.' => 'システム管理者のメール',
        ...
        'FAQ ARTICLES' => 'FAQ記事',
        'FAQ Articles' => 'FAQ記事',
        'FAQ Category Management' => 'FAQ カテゴリー管理',
        'FAQ Explorer' => 'FAQ一覧',
        'FAQ Journal' => 'FAQ ジャーナル',
        'FAQ Journal Overview "Small" Limit' => 'FAQジャーナル一覧 制限(小)',
        'FAQ Language Management' => 'FAQ 言語管理',
        'FAQ Search Result' => 'FAQ検索結果',
        'FAQ System History' => 'FAQシステム履歴',
        'FAQ limit per page for FAQ Journal Overview "Small"' => 'FAQジャーナル一覧 ページ毎のFAQ制限(小)',
        'Fax{CustomerUser}' => 'Fax',
        'File-Name' => 'ファイル名',
        'File-Path' => 'ファイルパス',
        'Filelist' => 'ファイルリスト',
        'Filter for Classes' => 'クラス名フィルタリング（クラス名を入力して下さい）',
        ...
        'For very complex stats it is possible to include a hardcoded file.' =>
            '非常に複雑な統計データについてはハードコーディングされたファイルをインクルードできます。',
        ...
        'Here you can define the value series. You have the possibility to select one or two elements. Then you can select the attributes of elements. Each attribute will be shown as single value series. If you don\'t select any attribute all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' =>
            'ここでは値系列を定義することができます。各要素は単一の系列として表示されます。統計を生成する時に要素なにも選択しない場合、最後の新規要素が追加されます。',
        'Here you can define the x-axis. You can select one element via the radio button. If you make no selection all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' =>
            'ここではX軸を定義することができます。ラジオボタンで1つの要素を選択してください。統計を生成する時に要素なにも選択しない場合、最後の新規要素が追加されます。',
        ...
        'If you use RegExp, you also can use the matched value in () as [***] in \'Set\'.' =>
            '正規表現を使う場合、()内に[****]として値を記入できます。',
        'If you want to install OTRS on other database systems, please refer to the file README.database.' =>
            'OTRSを違うデータベースシステムにインストールしたい場合は、README.databaseファイルを参照してください。',
        'Image' => '画像',
        'Impact' => '影響度',
        'Impact \ Category' => '影響度＼重要度',
        'Impact \ Criticality' => '影響度＼重要度',
        'ImpactID' => '影響度ID',
        'Import and export object information.' => 'オブジェクト情報をインポートとエクスポート',
        'Import information' => 'インポート情報',
        'Import/Export' => 'インポート/エクスポート',
        'Import/Export Management' => 'インポート/エクスポート管理',
        'Important' => '重要',
        'Imported' => 'インポート済',
        'Imported by' => 'インポート済: ',
        'In order to experience OTRS, you\'ll need to enable Javascript in your browser.' =>
            'OTRSを体験するには、お使いのブラウザのJavascriptを有効にしてください。',
        'In this form you can select the basic specifications.' => 'このフォームで基本的な仕様を選択できます。',
        'In this way you can directly edit the keyring configured in Kernel/Config.pm.' =>
            'この方法で、直接Kernel/Config.pmにキーリング設定を編集できます。',
        'Inbound Mail Password' => '受信メールパスワード',
        'Inbound Mail Type' => '受信メールタイプ',
        'Inbound Mail User' => '受信メールユーザー',
        'Inbound Mail host' => '受信メールホスト',
        'Incident State' => 'インシデント状態',
        'Include Column Headers' => '列ヘッダを含める',
        ...
        'Login failed! Your username or password was entered incorrectly.' =>
            'ログイン失敗！ 入力されたユーザー名またはパスワードが違います。',
        'Mail Management' => 'メール管理',
        'Mailbox' => 'メールボックス',
        'Manage priority matrix.' => '優先度の関連性を管理',
        'Manage the priority result of combinating Category <-> Impact.' =>
            'カテゴリーおよび影響度間における優先度の結果を管理する。',
        'MasterTicket' => 'マスター・チケット',
        'Match' => '一致',
        ...
        'Model' => 'モデル',
        'Modified' => '変更',
        'Module to genetare ITSM config item statistics.' => 'ITSM構成アイテム統計を生成するためのモジュールです。',
        'Module to inform agents, via the agent interface, about the used charset. A notification is displayed, if the default charset is not used, e.g. in tickets.' =>
            'ユーザ文字セットに関して、担当者インタフェースを通じて、担当者に通知するモジュールです。もし、デフォルトの文字セットが使用されていない場合（チケット等において）、通知が表示されます。',
        'Modules' => 'モジュール',
        'Move notification' => '移転通知',
        'Multiple selection of the output format.' => '出力書式の複数選択',
        'My Queue' => '担当のキュー',
        'MyTickets' => '担当のチケット',
        'NEW - Class: Computer' => '新クラス: コンピュータ',
        'NEW - Class: Location' => '新クラス: ロケーション',
        'NEW - Class: Network' => '新クラス: ネットワーク',
        'Name is required!' => '名前が必要です！',
        'Name of TicketFreeField for Host.' => 'TicketFreeFieldのホスト名。',
        'Name of TicketFreeField for Service.' => 'TicketFreeFieldのサービス名。',
        'Named pipe acknowledge command.' => '名前付きパイプは、コマンドを認識する。',
        ...
        'Network' => 'ネットワーク',
        'Network Adapter' => 'ネットワーク・アダプター',
        'Network Adapter::IP Address' => 'ネットワークアダプタ::IPアドレス',
        ...
        'No Packages for requested Framework in this Online Repository, but Packages for other Frameworks!' =>
            'このオンラインリポジトリ内に要求されたフレームワークのパッケージはありませんでした。しかし他のフレームワークにパッケージがあります。',
        'No Packages or no new Packages in selected Online Repository!' =>
            'パッケージがないか、新パッケージは選択されたオンラインリポジトリにありません。',
        'No Permission' => '権限がありません。',
        'No matches found' => '一致しません。',
        'No subcategories found.' => 'サブカテゴリーが登録されていません。',
        'No time settings.' => '時間設定がありません。',
        'Node-Address' => 'ノードアドレス',
        'Node-Name' => 'ノード名',
        'Note Text' => '注釈文',
        'Notification (Customer)' => '通知 (顧客)',
        'Notification (ITSM Change Management)' => '通知(ITSM変更管理)',
        'Notifications' => '通知',
        'OTRS DB Password' => 'OTRS DBパスワード',
        'OTRS sends an notification email to the customer if the ticket is moved.' =>
            'OTRSはチケットが移転されたことを顧客にメールで通知します。',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' =>
            'OTRSはチケット所有者が変更されたことを顧客にメールで通知します。',
        'OTRS sends an notification email to the customer if the ticket state has changed.' =>
            'OTRSはチケットの状態が変更されたことを顧客にメールで通知します。',
        'Object already linked as %s.' => 'オブジェクトは既に %s と連結されています。',
        'Of couse this feature will take some system performance it self!' =>
            'この機能はシステムのパフォーマンスに多少影響があります。',
        'One or more errors occured!' => '一つ以上のエラーが発生しました！',
        'Only for ArticleCreate Event.' => '記事作成イベントのみ',
        'Open Tickets' => '対応中チケット',
        'Operating System' => 'オペレーティング・システム',
        'Options of the current customer user data (e. g. &lt;OTRS_CUSTOMER_DATA_USERFIRSTNAME&gt;)' =>
            '現在の顧客ユーザーデータオプション (例 &lt;OTRS_CUSTOMER_DATA_USERFIRSTNAME&gt;)',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)' =>
            '現在の顧客ユーザーデータオプション (例 <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>).' =>
            '現在の顧客ユーザーデータオプション (例 <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Options of the current user who requested this action (e. g. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)' =>
            'この操作を要求した現在ユーザーオプション (例 &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)' =>
            'この操作を要求した現在ユーザーオプション (例 <OTRS_CURRENT_UserFirstname>)',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>).' =>
            'この操作を要求した現在ユーザーオプション (例 <OTRS_CURRENT_UserFirstname).',
        'Options of the ticket data (e. g. &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)' =>
            'チケットデータオプション (例 &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)',
        'Options of the ticket data (e. g. <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' =>
            'チケットデータオプション (例 <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' =>
            'チケットデータオプション (例 <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_TicketID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>).' =>
            'チケットデータオプション (例 <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_TicketID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>).',
        'Other Equipmen' => 'その他装置',
        'Other Options' => '他のオプション',
        'Out Of Office' => '勤務時間外',
        'Outbound Mail Type' => '送信メールタイプ',
        'Overview: ITSM ConfigItem: Computer' => 'コンピュータ構成項目の一覧',
        'PLANNEDENDTIME' => '予定終了日時',
        'PLANNEDSTARTTIME' => '予定開始日時',
        ...
        'Permission settings. You can select one or more groups to make the configurated stat visible for different agents.' =>
            '権限設定。設定済みの統計情報が別の担当者に見えるように1つ以上のグループを選択できます。',
        ...
        'Process-Path' => 'プロセスパス',
        'Product' => '製品',
        'Projected Service Availability' => '計画上のサービス可用性',
        ...
        'Select Change Template' => '変更テンプレートを選択',
        'Select Group' => 'グループを選択',
        'Select Source (for add)' => '先 (追加用)の選択',
        'Select a Class from the list to create a new Config Item.' => '構成アイテムを新規作成するには、リストからクラスを選択してください。',
        'Select a Class from the list to create a new Config Item. ' => '構成アイテムを新規作成するには、リストからクラスを選択してください。',
        'Select group' => 'グループを選択',
        'Select inbound mail type' => '受信メールタイプ選択',
        'Select outbound mail type' => '送信メールタイプ選択',
        ...
        'Sent password reset instructions to %s. Please check your email.' =>
            'パスワード初期化の説明を %s に送信しました。メールを確認してください。',
        ...
        'The customer is required.' => '顧客が入力されていません。',
        'The default selection of FreeTextField 12 if more than one option is defined.' =>
            'チケットについてfree text field number 12のデフォルトの一覧を定義します（2つ以上のオプションが提示された場合）。',
        'The field is required.' => '領域が入力されていません。',
        'The http acknowledge password.' => 'HTTPは、パスワードを認めます。',
        'The http acknowledge url.' => 'HTTPはURLを認めます。',
        'The http acknowledge user.' => 'HTTPはユーザを認識する。',
        'The identify of the system. Each ticket number and each http session id starts with this number.' =>
            'システムを識別します。それぞれのチケット番号とHTTPセッションはこの番号で始まるIDです。',
        'The logo shown in the header of the agent interface. The URL to the image must be a relative URL to the skin image directory.' =>
            '担当者インタフェースのヘッダーに表示されるロゴです。本イメージに対するURLは、スキン・イメージ・ディレクトリへの相対URLである必要があります。',
        'The logo shown in the header of the customer interface. The URL to the image must be a relative URL to the skin image directory.' =>
            '顧客インターフェイスの見出し中のロゴ。画像URLはスキン画像ディレクトリからの相対URLでなければならない',
        ...
        'The text is required.' => '本文が入力されていません。',
        'The used sender mail address.' => '使用される送信者のメールアドレス',
        ...
        'This is useful if you want that no one can get the result of the stat or the stat isn\'t ready configurated.' =>
            '設定できていないか、統計情報が欲しい場合に便利です。',
        'This module is preparing master/slave pulldown in email and phone ticket.' =>
            '本モジュールは、Eメールおよび電話チケットにおいてマスター/スレイブのプルダウンを準備するものです。',
        'This setting defines the link type \'AlternativeTo\'. If the source name and the target name contain the same value, the resulting link is a non-directional one. If the values are different, the resulting link is a directional link.' =>
            'リンク・タイプ\'AlternativeTo\'を定義します。ソース名とターゲット名が同じ値を含む場合、結果としてのリンクは非直接的なものになります。値が異なる場合、結果としてのリンクは直接リンクとなります。',
        'This setting defines the link type \'ConnectedTo\'. If the source name and the target name contain the same value, the resulting link is a non-directional one. If the values are different, the resulting link is a directional link.' =>
            'リンク・タイプ\'ConnectedTo\'を定義します。ソース名とターゲット名が同じ値を含む場合、結果としてのリンクは非直接的なものになります。値が異なる場合、結果としてのリンクは直接リンクとなります。',
        'This setting defines the link type \'DependsOn\'. If the source name and the target name contain the same value, the resulting link is a non-directional one. If the values are different, the resulting link is a directional link.' =>
            'リンク・タイプ\'DependsOn\'を定義します。ソース名とターゲット名が同じ値を含む場合、結果としてのリンクは非直接的なものになります。値が異なる場合、結果としてのリンクは直接リンクとなります。',
        'This setting defines the link type \'Includes\'. If the source name and the target name contain the same value, the resulting link is a non-directional one. If the values are different, the resulting link is a directional link.' =>
            'リンク・タイプ\'Includes\'を定義します。ソース名とターゲット名が同じ値を含む場合、結果としてのリンクは非直接的なものになります。値が異なる場合、結果としてのリンクは直接リンクとなります。',
        ...
        'Ticket Type is required!' => 'チケットタイプが入力されていません！',
        'Ticket escalation!' => 'チケットのエスカレーション！',
        'Ticket event module to send an acknowlage to Nagios.' => 'チケットイベントモジュールをNagiosにacknowlageを送信する。',
        'Ticket free text options shown in the additional ITSM field screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースにおける追加ITSMフィールド画面で表示される、チケット・フリー・テキストのオプションです。可能性ある設定：0 = 無効, 1 = 有効, 2 = 有効かつ必要。',
        'Ticket free text options shown in the close ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのクローズ・チケット画面で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free text options shown in the decision screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースにおける決定画面で表示される、チケット・フリー・テキスト・オプションです。可能性ある設定：0 = 無効, 1 = 有効, 2 = 有効かつ必要。',
        'Ticket free text options shown in the email ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのEメール・チケット画面で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free text options shown in the move ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースの移動チケット画面で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free text options shown in the phone ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースの電話チケット画面で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free text options shown in the ticket compose screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット構成画面で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free text options shown in the ticket forward screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット転送画面で、表示されるフリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.',
        'Ticket free text options shown in the ticket free text screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット・フリー・テキスト・スクリーンで、表示されるチケット・フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free text options shown in the ticket message screen of the customer interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required. NOTE. If you want to display these fields also in the ticket zoom of the customer interface, you have to enable them in CustomerTicketZoom###AttributesView.' =>
            '顧客インタフェースのチケット・メッセージ画面で表示される、チケット・フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。注意：もしこれらのフィールドを顧客インタフェースのチケット・ズームにおいても表示させたい場合、CustomerTicketZoom###AttributesViewで有効にする必要があります。',
        'Ticket free text options shown in the ticket note screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット・ノート画面で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free text options shown in the ticket owner screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのズームされたチケットのチケット所有者画面で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定 0 = Disabled, 1 = Enabled, 2 = Enabled and required.。',
        'Ticket free text options shown in the ticket pending screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのズームされたチケットのチケット保留画面で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定 0 = Disabled, 1 = Enabled, 2 = Enabled and required.。',
        'Ticket free text options shown in the ticket phone outbound screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット電話アウトバウンド画面で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free text options shown in the ticket priority screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのズームされたチケットのチケット優先度画面で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定 0 = Disabled, 1 = Enabled, 2 = Enabled and required.',
        'Ticket free text options shown in the ticket responsible screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット責任者画面で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定 0 = Disabled, 1 = Enabled, 2 = Enabled and required.。',
        'Ticket free text options shown in the ticket search of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット検索で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free text options shown in the ticket search screen in the customer interface. Possible settings: 0 = Disabled and 1 = Enabled.' =>
            '顧客インタフェースのチケット検索画面で、表示されるチケット・フリー・テキストのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled。',
        'Ticket free time options shown in the additional ITSM field screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースにおける追加ITSMフィールド画面において表示される表示されるチケット・フリー・タイム・オプションです。可能性ある設定：0 = 無効, 1 = 有効, 2 = 有効かつ必要。',
        'Ticket free time options shown in the close ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのクローズ・チケット画面で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free time options shown in the decision screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースにおける決定画面で表示される、チケット・フリー・タイム・オプションです。可能性ある設定：0 = 無効, 1 = 有効, 2 = 有効かつ必要。',
        'Ticket free time options shown in the email ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのEメール・チケット画面で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free time options shown in the move ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースの移動チケット画面で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.',
        'Ticket free time options shown in the phone ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースの電話チケット画面で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.',
        'Ticket free time options shown in the ticket compose screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット構成画面で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free time options shown in the ticket forward screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット転送画面で、表示されるチケット・フリー・タイムオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free time options shown in the ticket free text screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット・フリー・テキスト・スクリーンで、表示されるチケット・フリー・タイム・オプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and requir.',
        'Ticket free time options shown in the ticket message screen of the customer interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required. NOTE. If you want to display these fields also in the ticket zoom of the customer interface, you have to enable them in CustomerTicketZoom###AttributesView.' =>
            '顧客インタフェースのチケット・メッセージ画面で表示される、チケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。注意：もしこれらのフィールドを顧客インタフェースのチケット・ズームにおいても表示させたい場合、CustomerTicketZoom###AttributesViewで有効にする必要があります。',
        'Ticket free time options shown in the ticket note screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット・ノート画面で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free time options shown in the ticket owner screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのズームされたチケットのチケット所有者画面で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free time options shown in the ticket pending screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのズームされたチケットのチケット保留画面で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free time options shown in the ticket phone outbound screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット電話アウトバウンド画面で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free time options shown in the ticket priority screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのズームされたチケットのチケット優先度画面で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free time options shown in the ticket responsible screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' =>
            '担当者インタフェースのチケット責任者画面で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled, 2 = Enabled and required。',
        'Ticket free time options shown in the ticket search of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.' =>
            '担当者インタフェースのチケット検索で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled。',
        'Ticket free time options shown in the ticket search screen in the customer interface. Possible settings: 0 = Disabled and 1 = Enabled.' =>
            '顧客インタフェースのチケット検索で、表示されるチケット・フリー・タイムのオプションです。可能性ある設定: 0 = Disabled, 1 = Enabled。',
        ...
        'Ticket responsible options (e. g. <OTRS_RESPONSIBLE_UserFirstname>).' =>
            'チケット応答者オプション (例 <OTRS_RESPONSIBLE_UserFirstname>).',
        ...
        'Warning! This tickets will be removed from the database! This tickets are lost!' =>
            '警告: このチケットをデータベースから削除しようとしています。このチケットは失われます！',
        'Warranty Expiration Date' => '契約満了日',
        ...
        'With the input and select fields you can configurate the stat at your needs. Which elements of a stat you can edit depends on your stats administrator who configurated the stat.' =>
            '必要に応じて入力領域を選択し、統計情報を設定できます。統計情報は管理者が設定した範囲内でどの統計の要素も編集できます。',
        ...
        'You need a email address (e. g. customer@example.com) in To:!' =>
            '宛先にメールアドレスを入力してください！ (例 kunde@example.com)',
        ...
        'You use the DELETE option! Take care, all deleted Tickets are lost!!!' =>
            '削除オプションを使います。全ての削除されたチケットは消失します！',
        'Your Password' => 'パスワード',
