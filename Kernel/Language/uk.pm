...
# --
# $Id: uk.pm,v 1.37.2.2 2012/11/22 06:59:17 mb Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        '(Note: It depends on your installation how many dynamic objects you can use)' =>
            'Зауваження: кількість динамічних об\'єктів залежить від системи.',
        ...
        '(The identify of the system. Each ticket number and each http session id starts with this number)' =>
            'Ідентифікатор системи. Кожний номер заявки й сеанс починатися із цього числа)',
        ...
        'A response is default text to write faster answer (with default text) to customers.' =>
            'Відповідь — шаблон відповіді клієнтові',
        ...
        'All Customer variables like defined in config option Customeruser.' =>
            'Усі додаткові поля інформації про клієнта визначаються параметрах користувача.',
        'All customer tickets.' => 'Усі заявки клієнта.',
        'All email addresses get excluded on replaying on composing an email.' =>
            'Усі адреси, що виключаються при відповіді на лист',
        'All email addresses get excluded on replaying on composing and email.' =>
            'Усі додаткові адреси електронної пошти будуть виключатися у відповідному листі.',
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' =>
            'Усі вхідні повідомлення із цим одержувачем будуть спрямовані в задану чергу',
        ...
        'Can\'t update password, must contain 2 lower and 2 upper characters!' =>
            'Неможливо перемінити пароль, необхідно 2 символу в нижньому й 2 — у верхньому регістрах!',
        ...
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).' =>
            'Створити нові групи для призначення прав доступу групам агентів (відділ закупівель, відділ продажів, відділ техпідтримки й т.п.)',
        ...
        'Customer user will be needed to have a customer history and to login via customer panel.' =>
            'Користувач клієнта знадобиться, щоб одержувати доступ до історії клієнта й входити через користувацький інтерфейс',
        'Customeruser' => 'Клієнт',
        ...
        'Do dispatch or filter incoming emails based on email X-Headers! Regexp is also possible.' =>
            'Обробляти або відфільтрувати вхідні листи на основі полів заголовка! Можливе використання регулярних виражень.',
        'Do you really want to delete this Object?' => 'Вилучити цей об\'єкт?',
        'Do you really want to reinstall this package (all manual changes get lost)?' =>
            'Переустановити цей пакет (усі зміни, зроблені вручну, будуть загублені)?',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' =>
            'Не працюйте под обліковим записом UserID 1 (сисемним аккаунтом)! Створіть нового користувача!',
        ...
        'For very complex stats it is possible to include a hardcoded file.' =>
            ' Для дуже складних звітів, можливо, необхідно використовувати тимчасовий файл',
        'Form' => 'Форма',
        ...
        'Here you can define the value series. You have the possibility to select one or two elements. Then you can select the attributes of elements. Each attribute will be shown as single value series. If you don\'t select any attribute all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' =>
            'Тут ви можете визначити послідовність значень. У вас є можливість вибрати один або два елементи. Потім ви можете вибрати атрибути елементів. Значення кожного атрибута буде показані як окрема послідовність значень. Якщо ви не виберіть жодного атрибута, у звіті будуть використані всі доступні атрибути.',
        'Here you can define the x-axis. You can select one element via the radio button. If you make no selection all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' =>
            'Тут ви можете визначити значення для осі X. Виберіть один елемент, використовуючи перемикач. Якщо ви не виберіть жодного атрибута, у звіті будуть використані всі доступні атрибути.',
        'Here you can define the x-axis. You can select one element via the radio button. Then you you have to select two or more attributes of the element. If you make no selection all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' =>
            'Тут ви можете визначити вісь X. У вас є можливість вибрати один або два елементи. Потім ви можете вибрати атрибути елементів. Значення кожного атрибута буде показані як окрема послідовність значень. Якщо ви не виберіть жодного атрибута, у звіті будуть використані всі доступні атрибути.',
        ...
        'If Secure Mode is not activated, activate it via Sysconfig because your application is already running.' =>
            'Якщо безпечний режим не включений, включите його в конфігурації системи',
        'If a new hardcoded file is available this attribute will be shown and you can select one.' =>
            'Якщо тимчасовий файл доступний, буде показаний список, з якого ви можете вибрати файл.',
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.' =>
            'Якщо заявка закрита, а клієнт надіслав повідомлення, то заявка буде заблокована для попереднього власника',
        'If a ticket will not be answered in this time, just only this ticket will be shown.' =>
            'Якщо заявка не буде обслужена у встановлений час, показувати тільки цю заявку',
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.' =>
            'Якщо агент заблокував заявку й не відправила відповідь клієнтові протягом установленого часу, то заявка автоматично розблокується й стане доступною для інших агентів.',
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).' =>
            'Якщо нічого не обране, то заявки будуть недоступні для користувача',
        'If secure mode is not activated, activate it via Sysconfig because your application is already running.' =>
            'Якщо безпечний режим не активований, включите його через Sysconfig, оскільки ваш додаток уже запущений.',
        ...
        'If you use Regexp, you also can use the matched value in () as [***] in \'Set\'.' =>
            'Якщо ви використовуєте регулярні вираження, ви можете використовувати змінні в () як [***] при установці значень',
        'If your account is trusted, the already existing X-OTRS header at arrival time (for priority, ...) will be used! Postmaster filter will be used anyway.' =>
            'Якщо ваш обліковий запис безпечний, у листах буде використане поле заголовка X-OTRS ( для пріоритету й інших даних)! Фільтр Postmaster буде використаний у кожному разі.',
        'Image' => 'Значок',
        'Important' => 'Важливо',
        'In this form you can select the basic specifications.' => 'У даній формі ви можете вибрати основні вимоги.',
        'In this way you can directly edit the keyring configured in Sysconfig.' =>
            ' У цьому випадку ви можете змінити ключі прямо в конфігурації системи',
        ...
        'Login failed! Your username or password was entered incorrectly.' =>
            'Помилка аутентефікації! Ім\'я або пароль невірні!',
        ...
        'No Packages for requested Framework in this Online Repository, but Packages for other Frameworks!' =>
            'Немає пакетів для запитаного середовища в цьому мережному репозитории, але є пакети для інших середовищ!',
        'No Packages or no new Packages in selected Online Repository!' =>
            'Немає пакетів або нових пакетів в обраному мережному репозитории!',
        ...
        'OTRS sends an notification email to the customer if the ticket is moved.' =>
            ' При переміщенні заявки буде відправлене повідомлення клієнтові.',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' =>
            ' При зміні власника заявки буде відправлене повідомлення клієнтові.',
        'OTRS sends an notification email to the customer if the ticket state has changed.' =>
            ' При зміні статусу заявки буде відправлене повідомлення клієнтові.',
        'Object already linked as %s.' => 'Об\'єкт уже пов\'язаний з «%s»!',
        'Of couse this feature will take some system performance it self!' =>
            'Дана функція використовує системні ресурси!',
        'Online' => 'Онлайн',
        'Only for Articlecreate Event.' => 'Тільки при створенні повідомлень',
        'Open Tickets' => 'Відкриті заявки',
        'Options ' => 'Дані',
        'Options of the current customer user data (e. g. &lt;OTRS_CUSTOMER_DATA_USERFIRSTNAME&gt;)' =>
            'Поля інформації про клієнта (наприклад, &lt;OTRS_CUSTOMER_DATA_USERFIRSTNAME&gt;)',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_Userfirstname>)' =>
            'Поля інформації про користувача (наприклад, <OTRS_CUSTOMER_DATA_Userfirstname>)',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_Userfirstname>).' =>
            'Поточні дані про клієнта (наприклад, <OTRS_CUSTOMER_DATA_Userfirstname>).',
        'Options of the current user who requested this action (e. g. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)' =>
            'Поля інформації про користувача, який запросив цю дію (наприклад, &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_Userfirstname>)' =>
            'Поля інформації про користувача, який запросив цю дію (наприклад <OTRS_CURRENT_Userfirstname>)',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_Userfirstname>).' =>
            'Дані поточного користувача, який запросив цю дію (наприклад, <OTRS_CURRENT_Userfirstname>).',
        'Options of the ticket data (e. g. &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)' =>
            'Поля заявки (наприклад, &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)',
        'Options of the ticket data (e. g. <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' =>
            'Поля інформації про заявку (наприклад, <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Options of the ticket data (e. g. <OTRS_TICKET_Ticketnumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' =>
            'Поля інформації про заявку (наприклад, <OTRS_TICKET_Ticketnumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Options of the ticket data (e. g. <OTRS_TICKET_Ticketnumber>, <OTRS_TICKET_Ticketid>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' =>
            'Поля інформації про заявку (наприклад, <OTRS_TICKET_Ticketnumber>, <OTRS_TICKET_Ticketid>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Options of the ticket data (e. g. <OTRS_TICKET_Ticketnumber>, <OTRS_TICKET_Ticketid>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>).' =>
            'Дані заявки (наприклад, <OTRS_TICKET_Ticketnumber>, <OTRS_TICKET_Ticketid>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>).',
        ...
        'Package not correctly deployed! You should reinstall the Package again!' =>
            'Пакет встановлено некоректно! Ви повинні переінсталювати його!',
        'Param 1' => 'Параметр 1',
        'Param 2' => 'Параметр 2',
        'Param 3' => 'Параметр 3',
        'Param 4' => 'Параметр 4',
        ...
        'Permission settings. You can select one or more groups to make the configurated stat visible for different agents.' =>
            'Настроювання прав доступу. Ви можете вибрати одну або кілька груп, щоб звіт був бачив для різних користувачів.',
        ...
        'Please remember, that the scale for value series has to be larger than the scale for the X-axis (e.g. X-Axis => Month, Valueseries => Year).' =>
            'Помніть, що масштаб для послідовності значень повинен бути більше, ніж масштаб для осі X (наприклад, вісь Х — місяць, послідовність значень — рік).',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.' =>
            'Надіслати мені повідомлення, якщо клієнт надіслав відповідь і я власник заявки.',
        'Send me a notification of an watched ticket like an owner of an ticket.' =>
            'Надіслати мені й власникові повідомлення, якщо оновлена заявка, що відслідковується.',
        ...
        'Take care that you also updated the default states in you Kernel/Config.pm!' =>
            'Виправте стани за замовчуванням також і у файлі Kernel/Config.pm!',
        ...
        'This is useful if you want that no one can get the result of the stat or the stat isn\'t ready configurated.' =>
            'Це корисно використовувати для приховання звіту (наприклад, він ще не до кінця настроєний).',
        ...
        'Ticket owner options (e. g. &lt;OTRS_OWNER_USERFIRSTNAME&gt;)' =>
            'Поля інформації про власника заявки (наприклад, &lt;OTRS_OWNER_USERFIRSTNAME&gt;)',
        ...
        'Ticket responsible options (e. g. <OTRS_RESPONSIBLE_Userfirstname>).' =>
            'Дані відповідального за заявку (наприклад, <OTRS_RESPONSIBLE_Userfirstname>).',
        ...
        'WARNING: When you change the name of the group \'admin\', before making the appropriate changes in the Sysconfig, you will be locked out of the administrations panel! If this happens, please rename the group back to admin per SQL statement.' =>
            'УВАГА! Якщо ви зміните ім\'я групи «admin» до того, як поміняєте назву цієї групи конфігурації системи, у вас не буде прав доступу на панель адміністрування. Якщо це відбулося, поверніть колишню назву групи (admin) вручну командою SQL.',
        'Warning! This tickets will be removed from the database! This tickets are lost!' =>
            'Увага! Зазначені заявки будуть вилучені з бази!',
        ...
        'With the input and select fields you can configurate the stat at your needs. Which elements of a stat you can edit depends on your stats administrator who configurated the stat.' =>
            'Уводячи дані й вибираючи поля, ви можете набудовувати звіт як вам необхідно. Від адміністратора, що створював даний звіт, залежить які данні ви можете набудовувати. ',
        'Yes means, send no agent and customer notifications on changes.' =>
            '«Так» — не відправляти повідомлення агентам і клієнтам при змінах.',
        'Yes, save it with name' => ' Так, зберегти з іменем',
        'You got new message!' => 'Ви отримали нове повідомлення',
        'You have to select two or more attributes from the select field!' =>
            'Вам необхідно вибрати два або більш пунктів з обраного поля!',
        'You need a email address (e. g. customer@example.com) in To:!' =>
            'Укажіть адресу електронної пошти в поле одержувача (наприклад, support@example.ru)!',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is bounced to "<OTRS_BOUNCE_TO>". Contact this address for further information.' =>
            'Ваш лист із номером заявки "<OTRS_TICKET>" відкинуть і пересланий за адресою "<OTRS_BOUNCE_TO>". Будь ласка, зв\'яжіться по цій адресі для з\'ясування причин.',
